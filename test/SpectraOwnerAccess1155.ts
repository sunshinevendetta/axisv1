...
describe("SpectraOwnerAccess1155", function () {
  ...
  it("prevents peer-to-peer transfers so the keys stay soulbound", async function () {
    ...
    ).to.be.revertedWith("SPECTRA_OWNER_ACCESS_NON_TRANSFERABLE");
  });
