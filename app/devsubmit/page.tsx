...
const bentoCards: BentoCardProps[] = [
  {
    ...
    imageSrc: "/ep3.webp",
    imageAlt: "AXIS live activation scene",
  },
  {
    color: "#05010c",
    label: "The Ecosystem",
    ...
    imageSrc: "/ep1-5.webp",
    imageAlt: "AXIS ecosystem overview",
  },
  {
    color: "#05010c",
    label: "The Method",
    ...
    imageSrc: "/ep1.jpg",
    imageAlt: "AXIS field test activation",
  },
  {
    color: "#05010c",
    ...
    imageSrc: "/ep1.webp",
    imageAlt: "AXIS activation model",
  },
  {
    color: "#05010c",
    label: "What To Send",
    ...
    imageSrc: "/poster.jpg",
    imageAlt: "AXIS submission guidance visual",
  },
  {
    color: "#05010c",
    label: "Outcome",
    ...
    imageSrc: "/soon.jpg",
    imageAlt: "AXIS feedback and launch preview",
  },
  {
    color: "#05010c",
    ...
    imageSrc: "/ep3.png",
    imageAlt: "AXIS token check-in mechanic",
  },
  {
    color: "#05010c",
    label: "Example Mechanic",
    ...
    imageSrc: "/ep3.jpg",
    imageAlt: "AXIS game reward mechanic",
  },
  {
    color: "#05010c",
    label: "Example Mechanic",
    ...
    imageSrc: "/ep1-5.jpg",
    imageAlt: "AXIS waitlist access mechanic",
  },
  {
    color: "#05010c",
    label: "Example Mechanic",
    ...
    imageSrc: "/ep1-5.webp",
    imageAlt: "AXIS wallet interaction mechanic",
  },
];
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="mb-12 max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-base leading-7 text-white/70 sm:text-lg">
                This lane is for developers and digital builders who want to test products in live event environments,
                observe real behavior, and get direct feedback from the AXIS<span className="copy-mark">©</span>{" "}
                ecosystem.
              </p>
            </div>
