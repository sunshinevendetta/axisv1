...
export const metadata: Metadata = {
  title: "SPECTRA Documents",
  description: "Project documentation, operational guides, and architecture notes for SPECTRA.",
};
        ...
        <div className="grid gap-4 xl:hidden">
          {documents.map((document, index) => (
            <Link
              key={document.slug}
              href={`/docs/${document.slug}`}
              className="rounded-[26px] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.06),rgba(148,163,184,0.04))] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.34)] backdrop-blur-2xl transition-all hover:border-[#dbe4f2]/24"
            >
              ...
              <div className="mt-4 inline-flex rounded-full border border-[#dbe4f2]/24 bg-[linear-gradient(135deg,rgba(236,241,247,0.18),rgba(138,166,198,0.12))] px-4 py-2 text-sm text-white/84">
                Open document
              </div>
            </Link>
          ))}
            ...
            <div className="rounded-[30px] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.06),rgba(148,163,184,0.04))] p-5 shadow-[0_22px_70px_rgba(0,0,0,0.36)] backdrop-blur-2xl">
              ...
              <div className="mt-6 space-y-3 rounded-2xl border border-white/8 bg-black/25 p-4">
                <div>
                  ...
                  <div className="mt-2 text-sm text-[#d7e3f3]">/docs</div>
                </div>
                <Link
                  href="/docs/diagrams"
          ...
          <div className="grid gap-6">
            {documents.map((document, index) => (
              <section
                key={document.slug}
                id={document.slug}
                className="rounded-[32px] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.06),rgba(148,163,184,0.04))] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.42)] backdrop-blur-2xl sm:p-6"
              >
