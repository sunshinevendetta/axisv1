// Server-rendered semantic content for /kibibotproposal.
//
...
export default function PlanContent() {
  return (
    <>
      ...
      */}
      <article className="pbo-a11y-content" aria-label="AXIS · Programa de Junio · Propuesta Kibibot (texto)">
        <header>
        ...
        <section aria-labelledby="pbo-h-format">
          ...
          <ul>
            ...
            <li>Onboarding — instrucciones claras entregadas en sitio para entrar a Kibibot.</li>
          </ul>
          <h3>E. Capa de activación</h3>
          <ul>
            <li>Guiado por staff — el staff guía a los invitados para tomar fotos del evento y crear tokens en Kibibot.</li>
            <li>Canje de bebidas — los tokens creados por los invitados se usan para redimir bebidas dentro de la sede.</li>
          ...
          <ul>
            <li>Foto-token en sitio — los invitados crean tokens desde fotos tomadas durante el evento.</li>
            <li>Flujo de recompensas — onboarding, foto, token, bebida, pantalla y reporte.</li>
            <li>Insights post-evento — tokens creados, canjes, contenido y asistencia después.</li>
          </ul>
        </section>
        ...
        <section aria-labelledby="pbo-h-system">
          ...
          <ol>
            ...
            <li>Tomar fotos del evento.</li>
            <li>Crear tokens en Kibibot.</li>
            <li>Usar los tokens para redimir bebidas y beneficios.</li>
        ...
        <section aria-labelledby="pbo-h-offer">
          ...
          <p>
            ...
            en la sede, no una venta. Onboarding en sitio, fotos del evento, tokens creados en Kibibot,
            redención de bebidas, contenido, capturas, testimonios y documentación, todo construido dentro
            de Bar Oriente.
          </p>
          <p>Precio: 1,000 USD total, 500 USD por activación. Estamos abiertos a conversar términos.</p>
          <p>Lo que montamos incluye:</p>
          <ul>
            <li>Branding en wallet</li>
            <li>Canje de bebidas con tokens creados en Kibibot</li>
            <li>Guestlist para invitados</li>
            <li>Activación NFC</li>
            <li>Pantallas de onboarding</li>
            <li>Pantallas de recompensa</li>
            <li>Staff e instrucciones en sitio</li>
            ...
            <li>Foto-token en sitio</li>
            <li>Capturas de emplazamiento</li>
            <li>Reporte de asistencia</li>
            <li>Insights de tokens creados en Kibibot</li>
            <li>Insights de onboarding</li>
