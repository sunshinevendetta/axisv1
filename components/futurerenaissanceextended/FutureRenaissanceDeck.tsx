...
export default function FutureRenaissanceExtendedDeck() {
  ...
  const syncDeckLanguage = useCallback(() => {
    ...
    document
      .querySelectorAll<HTMLIFrameElement>('iframe[data-future-renaissance-extended-deck="true"]')
      .forEach((iframe) => {
  ...
  return (
    <>
      ...
      <div className="future-deck-desktop">
        <iframe
          data-future-renaissance-extended-deck="true"
          src="/futurerenaissanceextended/axis-horizontal.html"
      ...
      <div className="future-deck-mobile">
        <iframe
          data-future-renaissance-extended-deck="true"
          src="/futurerenaissanceextended/axis-vertical.html"
