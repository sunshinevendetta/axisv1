const EVENT_JSON_LD = {
  ...
  image: "https://axis.show/futurerenaissance-archipielago/poster-horizontal.png",
};
  ...
  return (
    <>
      ...
      <article
        ...
        aria-label="Future Renaissance host group presentation for Archipiélago"
      >
        <header>
          ...
          <p>Host group: Archipiélago · venue within the group to be confirmed</p>
        ...
        <section aria-labelledby="future-event">
          ...
          <p>
            The night runs in two halves with Archipiélago, the host group, in
            Mexico City on October 28, 2026. Archipiélago operates venues rather
            than being a single room, so the first thing to agree is which venue in
            the group hosts the night. From 18:00 to 21:00 it is a seated Claude
