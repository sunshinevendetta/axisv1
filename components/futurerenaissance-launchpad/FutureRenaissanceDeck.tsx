...
export default function FutureRenaissanceExtendedDeck() {
  ...
  const syncDeckLanguage = useCallback(() => {
    ...
    document
      .querySelectorAll<HTMLIFrameElement>('iframe[data-future-renaissance-launchpad-deck="true"]')
      .forEach((iframe) => {
  ...
  return (
    <>
      ...
      <div className="future-deck-desktop">
        <iframe
          data-future-renaissance-launchpad-deck="true"
          src="/futurerenaissance-launchpad/axis-horizontal.html"
      ...
      <div className="future-deck-mobile">
        <iframe
          data-future-renaissance-launchpad-deck="true"
          src="/futurerenaissance-launchpad/axis-vertical.html"
