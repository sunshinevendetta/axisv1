...
export default function FutureRenaissanceExtendedDeck() {
  ...
  const syncDeckLanguage = useCallback(() => {
    ...
    document
      .querySelectorAll<HTMLIFrameElement>('iframe[data-future-renaissance-wallet-deck="true"]')
      .forEach((iframe) => {
  ...
  return (
    <>
      ...
      <div className="future-deck-desktop">
        <iframe
          data-future-renaissance-wallet-deck="true"
          src="/futurerenaissance-wallet/axis-horizontal.html"
      ...
      <div className="future-deck-mobile">
        <iframe
          data-future-renaissance-wallet-deck="true"
          src="/futurerenaissance-wallet/axis-vertical.html"
