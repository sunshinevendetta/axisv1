const PROPOSAL_JSON_LD = {
  "@context": "https://schema.org",
  "@type": "CreativeWork",
  name: "Trading Arena by OKX at Bar Oriente",
  description:
    "Trading Arena by OKX en Bar Oriente: el torneo de trading mas intenso jamas realizado en LATAM, con Human Traders, AI Agents, mercados en movimiento y leaderboards en vivo.",
  about: {
    "@type": "Place",
    name: "Bar Oriente",
    address: {
  ...
  image: "https://axis.show/tradingtournament/baroriente.jpg",
};

export default function TradingTournamentContent() {
  return (
    <>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(PROPOSAL_JSON_LD) }}
      />
      <style>{`
        .tt-a11y-content {
          position: absolute;
      ...
      `}</style>
      <article className="tt-a11y-content" aria-label="Trading Arena by OKX Proposal">
        <header>
          <h1>Trading Arena by OKX en Bar Oriente</h1>
