const EVENT_JSON_LD = {
  ...
  description:
    "A Claude community event at Diablito Secret Club, Mexico City: a seated, hands-on Claude workshop for the music industry from 18:00 to 21:00 with 200 attendees, followed from 22:00 by Future Renaissance, an AXIS Tech Week Mexico Edition event combining art, music, technology, culture, AI, code, community, hospitality, interactive activities and live media, for 250 further guests.",
  location: {
    "@type": "Place",
    name: "Diablito Secret Club",
    address: {
      "@type": "PostalAddress",
      streetAddress: "Monterrey 80, Colonia Roma",
  ...
  image: "https://axis.show/futurerenaissance-diablito/poster-horizontal.png",
};
  ...
  return (
    <>
      ...
      <article
        ...
        aria-label="Future Renaissance venue presentation for Diablito Secret Club"
      >
        <header>
          ...
          <p>Host venue: Diablito Secret Club</p>
          <p>Monterrey 80, Colonia Roma, Cuauhtémoc, 06700 Ciudad de México, CDMX</p>
        ...
        <section aria-labelledby="future-event">
          ...
          <p>
            The night runs in two halves at Diablito Secret Club, the host venue, on
            Monterrey 80 in Colonia Roma, Mexico City, on October 28, 2026. From 18:00 to 21:00 it is a seated Claude
