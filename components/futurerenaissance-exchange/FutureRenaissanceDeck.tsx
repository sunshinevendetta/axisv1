...
export default function FutureRenaissanceExtendedDeck() {
  ...
  const syncDeckLanguage = useCallback(() => {
    ...
    document
      .querySelectorAll<HTMLIFrameElement>('iframe[data-future-renaissance-exchange-deck="true"]')
      .forEach((iframe) => {
  ...
  return (
    <>
      ...
      <div className="future-deck-desktop">
        <iframe
          data-future-renaissance-exchange-deck="true"
          src="/futurerenaissance-exchange/axis-horizontal.html"
      ...
      <div className="future-deck-mobile">
        <iframe
          data-future-renaissance-exchange-deck="true"
          src="/futurerenaissance-exchange/axis-vertical.html"
