...
export function Profile({
  ...
  return (
    <div className="pdq-enter-fade" style={{ padding: "120px var(--pdq-pad-x) 80px" }}>
        ...
        <Brackets className="glass" style={{ padding: 28 }}>
          ...
          <div style={{ borderTop: "1px solid var(--pdq-line)", paddingTop: 18 }}>
            ...
            <div className="pdq-display-alt" style={{ fontSize: 16, color: "var(--pdq-ink-2)" }}>
              {language === "es"
                ? `Gana ${me.nextReq - me.xp} XP mas para desbloquear ${me.nextRank}. Aparecen medallas poster y scans ocultos.`
                : `Earn ${me.nextReq - me.xp} more XP to unlock ${me.nextRank}. Hidden poster medals and scans surface.`}
            </div>
          </div>
        </Brackets>
      </div>
      ...
      {selectedMedal && (
        <div
          className="pdq-sheet-overlay pdq-medal-overlay"
          onClick={(e) => {
            if (e.target === e.currentTarget) setSelectedMedal(null);
          }}
          style={{
            position: "fixed",
            inset: 0,
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className="pdq-hero-2col pdq-sheet-2col pdq-sheet-body"
                style={{
                  padding: 32,
                  display: "grid",
                  gridTemplateColumns: "1fr 1fr",
              ...
              >
                  ...
                  <div className="pdq-medal-stack">
                    ...
                    <span className="pdq-medal-stack-center">
                      <Medal
                        ...
                        type={selectedMedal.typeInfo?.glyph}
                        imageSrc={selectedMedal.poster}
                      />
                    </span>
                  </div>
                </div>
                <div>
                  ...
                  >
                    {language === "es"
                      ? `Obtenida en ${selectedMedal.ep} via ${selectedMedal.typeInfo?.name.toLowerCase()}. Puedes verla en AR apuntando tu telefono a una superficie plana.`
                      : `Earned at ${selectedMedal.ep} via ${selectedMedal.typeInfo?.name.toLowerCase()}. View it in AR by pointing your phone at any flat surface.`}
                  </div>
