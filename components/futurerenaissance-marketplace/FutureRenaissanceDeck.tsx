...
export default function FutureRenaissanceExtendedDeck() {
  ...
  const syncDeckLanguage = useCallback(() => {
    ...
    document
      .querySelectorAll<HTMLIFrameElement>('iframe[data-future-renaissance-marketplace-deck="true"]')
      .forEach((iframe) => {
  ...
  return (
    <>
      ...
      <div className="future-deck-desktop">
        <iframe
          data-future-renaissance-marketplace-deck="true"
          src="/futurerenaissance-marketplace/axis-horizontal.html"
          title="Future Renaissance Mexico Tech Week After Hours, desktop deck"
      ...
      <div className="future-deck-mobile">
        <iframe
          data-future-renaissance-marketplace-deck="true"
          src="/futurerenaissance-marketplace/axis-vertical.html"
          title="Future Renaissance Mexico Tech Week After Hours, mobile deck"
          onLoad={syncDeckLanguage}
          style={{
            position: "fixed",
            inset: 0,
      ...
      <div ref={languageRootRef} className="future-language">
        <button
          ...
          aria-controls="future-extended-language-dialog"
        ...
        >
          <div
            ...
            id="future-extended-language-dialog"
            className="future-language-panel"
            role="dialog"
            aria-modal="true"
            aria-labelledby="future-extended-language-title"
            aria-describedby="future-extended-language-description"
          ...
          >
            ...
            <h2 id="future-extended-language-title" className="future-language-title">
              Select <span>language</span>
            </h2>
            <p id="future-extended-language-description" className="future-language-intro">
