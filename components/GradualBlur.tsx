...
type GradualBlurStatics = React.NamedExoticComponent<PropsWithChildren<GradualBlurProps>> & {
...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      const k = cap(key);
      const mobileKey = `mobile${k}` as ResponsiveConfigKey;
      const tabletKey = `tablet${k}` as ResponsiveConfigKey;
      const desktopKey = `desktop${k}` as ResponsiveConfigKey;
...
const GradualBlurMemo = React.memo(GradualBlur) as GradualBlurStatics;
