...
export default function FutureRenaissanceExtendedDeck() {
  ...
  const syncDeckLanguage = useCallback(() => {
    ...
    document
      .querySelectorAll<HTMLIFrameElement>('iframe[data-future-renaissance-payments-deck="true"]')
      .forEach((iframe) => {
  ...
  return (
    <>
      ...
      <div className="future-deck-desktop">
        <iframe
          data-future-renaissance-payments-deck="true"
          src="/futurerenaissance-payments/axis-horizontal.html"
      ...
      <div className="future-deck-mobile">
        <iframe
          data-future-renaissance-payments-deck="true"
          src="/futurerenaissance-payments/axis-vertical.html"
