const EVENT_JSON_LD = {
  ...
  description:
    "A Claude community event at Mexa Cocina del Alma, Mexico City: a seated, hands-on Claude workshop for the music industry from 18:00 to 21:00 with 200 attendees, followed from 22:00 by Future Renaissance, an AXIS Tech Week Mexico Edition event combining art, music, technology, culture, AI, code, community, hospitality, interactive activities and live media, for 250 further guests.",
  location: {
    "@type": "Place",
    name: "Mexa Cocina del Alma",
    address: {
      "@type": "PostalAddress",
      streetAddress: "Av. Álvaro Obregón 180, Roma Norte",
      addressLocality: "Cuauhtémoc, Mexico City",
      addressRegion: "CDMX",
      postalCode: "06700",
      addressCountry: "MX",
    },
  ...
  image: "https://axis.show/futurerenaissance-extended/poster-horizontal.png",
};
  ...
  return (
    <>
      ...
      <article
        ...
        aria-label="Future Renaissance venue presentation for Mexa Cocina del Alma"
      >
        <header>
          ...
          <p>Host venue: Mexa Cocina del Alma</p>
          <p>Av. Álvaro Obregón 180, Roma Norte, Cuauhtémoc, 06700 Ciudad de México, CDMX</p>
        ...
        <section aria-labelledby="future-event">
          ...
          <p>
            The night runs in two halves at Mexa Cocina del Alma, the host venue, on
            Avenida Álvaro Obregón 180 in Roma Norte, Mexico City, on October 28, 2026. From 18:00 to 21:00 it is a seated Claude
