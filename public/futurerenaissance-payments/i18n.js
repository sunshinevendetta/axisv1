(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      /* @generated:es */
      "mechanics.issue.name": "EMITIR",
      "mechanics.issue.role": "Tarjeta provisionada con personal en sitio",
      "mechanics.tap.name": "TAP",
      "mechanics.tap.role": "Un tap compra un trago en la barra",
      "mechanics.repeat.name": "REPETIR",
      "mechanics.repeat.role": "La acción más repetida de la noche",
      "mechanics.tab.name": "CUENTA",
      "mechanics.tab.role": "Se abre en la puerta y se cierra al final",
      "mechanics.allocation.name": "ASIGNACIÓN",
      "mechanics.allocation.role": "El trago financiado pasa por su rail",
      "mechanics.split.name": "DIVIDIR",
      "mechanics.split.role": "Rondas divididas, reembolsos en sala",
      "mechanics.merchant.name": "COMERCIO",
      "mechanics.merchant.role": "Casa Luma es la contraparte real",
      "step.provision.stage": "PROVISIÓN",
      "step.provision.action": "TARJETA PROVISIONADA EN EL CHECK-IN",
      "step.tap.stage": "TAP",
      "step.tap.action": "EL PRIMER TRAGO SE PAGA CON UN TAP",
      "step.validate.stage": "VALIDACIÓN",
      "step.validate.action": "TRANSACCIÓN VERIFICADA EN LA BARRA",
      "step.redeem.stage": "REDENCIÓN",
      "step.redeem.action": "EL TRAGO FINANCIADO SE LIQUIDA",
      "step.screen.stage": "PANTALLA",
      "step.screen.action": "EL TOTAL DE LA NOCHE EN EL MURO",
      "step.report.stage": "REPORTE",
      "step.report.action": "CONCILIADO CON EL VENUE",
      "nav.brandFunction": "FUNCIÓN DE PAGOS",
      "brandFunction.kicker": "FUNCIÓN DE PAGOS",
      "brandFunction.title": "EL SOCIO NO PATROCINA LA BARRA. ES EL RAIL DE LA BARRA.",
      "brandFunction.copy": "Cada invitado en la sala compra o reclama un trago esa noche, lo que convierte a pagar un trago en la acción más repetida de todo el evento. Un socio de pagos es dueño de esa acción de punta a punta, con un venue real del otro lado.",
      "brandFunction.noLogoWall": "NO ES UN LOGO EN LA CARTA DE TRAGOS.",
      "brandFunction.distinctFunctions": "CADA TRAGO ES UNA TRANSACCIÓN DE COMERCIO REAL, CONTADA UNA POR UNA.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "UN TAP SE VUELVE UN TRAGO Y LUEGO UN REGISTRO DE COMERCIO LIQUIDADO.",
      "crossWeek.copy": "La cadena es corta y física: tap en la barra, trago en la mano, el venue cobrado por el rail del socio, el conteo de transacciones de la noche en el muro LED principal y cada movimiento conciliado contra los totales de Casa Luma en el reporte.",
    ...
    zh: {
      ...
      /* @generated:zh */
      "mechanics.issue.name": "发卡",
      "mechanics.issue.role": "在有工作人员的点位现场开通",
      "mechanics.tap.name": "刷卡",
      "mechanics.tap.role": "一次轻触买到一杯酒",
      "mechanics.repeat.name": "复用",
      "mechanics.repeat.role": "全场重复次数最多的动作",
      "mechanics.tab.name": "账单",
      "mechanics.tab.role": "进门开启，离场前结清",
      "mechanics.allocation.name": "额度",
      "mechanics.allocation.role": "被资助的酒水走同一条通道",
      "mechanics.split.name": "拆单",
      "mechanics.split.role": "整轮拆分，退款当场解决",
      "mechanics.merchant.name": "商户",
      "mechanics.merchant.role": "Casa Luma 是真实的对手方",
      "step.provision.stage": "开通",
      "step.provision.action": "入场时完成开卡",
      "step.tap.stage": "支付",
      "step.tap.action": "第一杯酒用一次刷卡完成",
      "step.validate.stage": "验证",
      "step.validate.action": "在吧台验证这笔交易",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "资助的酒水在通道内结算",
      "step.screen.stage": "上墙",
      "step.screen.action": "当晚总数出现在 LED 墙上",
      "step.report.stage": "报告",
      "step.report.action": "与场地账目逐笔对账",
      "nav.brandFunction": "支付功能",
      "brandFunction.kicker": "支付功能",
      "brandFunction.title": "合作方不是赞助这个吧台，而是这个吧台的支付通道。",
      "brandFunction.copy": "当晚在场的每一位来宾都会买下或领取一杯酒，这让“为一杯酒付款”成为整场活动中重复次数最多的动作。支付类合作方从头到尾拥有这个动作，而通道另一端是一个真实的场地。",
      "brandFunction.noLogoWall": "不是酒单上的一个标志。",
      "brandFunction.distinctFunctions": "每一杯酒都是一笔真实的商户交易，逐笔计数。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "一次刷卡变成一杯酒，再变成一笔已结算的商户记录。",
      "crossWeek.copy": "这条链路又短又实在：在吧台刷卡、酒到手上、场地通过合作方的通道收到钱、当晚交易笔数出现在主 LED 墙上，最后每一笔都与 Casa Luma 自己的账目在报告中逐笔核对。",
      "crossWeek.note": "仅为示例流程 · 具体行动将围绕该产品设计。",
    /* @end */
    }
  };
