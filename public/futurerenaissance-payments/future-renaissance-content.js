(function () {
  ...
  var slides = [
    ...
    /* @generated:slides */
    '<section class="fr-slide frx-brand-function" data-slide-id="brand-function" data-scene="structured" data-label="Payments function">' +
      frameTop("08", "brandFunction", "PAYMENTS FUNCTION") +
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="brandFunction.kicker">PAYMENTS FUNCTION</span><h2 data-reveal data-i18n="brandFunction.title">THE PARTNER DOES NOT SPONSOR THE BAR. IT IS THE BAR\'S RAIL.</h2><p data-reveal data-i18n="brandFunction.copy">Every guest in the room buys or claims a drink that night, which makes paying for a drink the most repeated action of the whole event. A payments partner owns that action end to end, with a real venue on the other side of it.</p></div>' +
      '<div class="frx-function-grid" data-crystallize>' + focus.mechanics.map(mechanicCard).join("") + '</div>' +
      '<div class="frx-brand-rule" data-reveal><span data-i18n="brandFunction.noLogoWall">NOT A LOGO ON THE DRINK MENU.</span><strong data-i18n="brandFunction.distinctFunctions">EVERY DRINK IS A REAL MERCHANT TRANSACTION, COUNTED ONE BY ONE.</strong></div>' +
    '</section>',
