(function () {
  ...
  var mechanics = [
    ...
    ["merchant", "Merchant", "The venue is a genuine merchant, not a simulation. Casa Luma sells the drinks, accepts the rail, and gets settled for exactly what it sold.", ["A working Mexico City bar with real inventory on the other side of the rail","Merchant-side acceptance tested across a full night of trading, not a pilot hour","Settlement to the venue reconciled against the venue's own totals","Measured as merchant volume settled and settlement time to the venue"], "Comercio", "El venue es un comercio real, no una simulación. Casa Luma vende los tragos, acepta el rail y recibe la liquidación por exactamente lo que vendió.", ["Un bar en operación en la Ciudad de México, con inventario real del otro lado","Aceptación del lado del comercio probada una noche completa, no una hora piloto","La liquidación al venue se concilia contra los totales del propio venue","Se mide como volumen de comercio liquidado y tiempo de liquidación al venue"], "商户", "场地是真实商户，不是模拟环境。Casa Luma 卖出这些酒，接受这条通道，并按实际售出的金额收到结算。", ["墨西哥城一家正在营业的酒吧，通道另一端是真实库存","商户侧受理经历了一整晚交易的检验，而不是一小时试点","对场地的结算与场地自己的账目逐笔核对","以已结算的商户交易额与到账时间计量"]],
  ];
  ...
  var rewardFlow = [
    ["provision", "Card provisioned at check-in", "Provisioning is attached to entry: the seated 100 are set up during the workshop, and the 120 arriving at 21:00 are set up as they come through the door.", ["Staffed points at both entries, so nobody onboards alone in a queue","The workshop block gives four unhurried hours for the first cohort","The guest is ready to pay before they have reached the bar","Measured as provisions completed against guests admitted"], "Tarjeta provisionada en el check-in", "La provisión va pegada a la entrada: los 100 sentados quedan listos durante el taller y los 120 que llegan a las 21:00 quedan listos al cruzar la puerta.", ["Puntos con personal en ambas entradas, nadie se onboardea solo en la fila","El bloque del taller da cuatro horas sin prisa para la primera cohorte","El invitado ya puede pagar antes de llegar a la barra","Se mide como provisiones completadas frente a invitados admitidos"], "入场时完成开卡", "开通与入场绑定：100 位座席来宾在工作坊期间办好，21:00 到场的 120 人在进门时办好。", ["两个入口都有值守点位，没有人要在队伍里独自摸索","工作坊时段为第一批人留出四个小时的从容时间","来宾在走到吧台之前就已经具备支付能力","以完成开通的人数与实际入场人数对照计量"]],
