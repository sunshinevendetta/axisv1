(function () {
  ...
  window.FUTURE_RENAISSANCE = deepFreeze({
    ...
    productFocus: {
      id: "launchpad",
      name: "Launchpad",
      slot: "[LAUNCHPAD BRAND]",
      discipline: "Launch platform for creator and artist tokens",
      mechanics: [
        { id: "livelaunch", name: "Live Launch", role: "One launch opens on the clock" },
        { id: "creatordesk", name: "Creator Desk", role: "200 professionals draft a launch" },
        { id: "allocation", name: "Earned Allocation", role: "Allocation earned, never purchased" },
        { id: "curve", name: "The Curve", role: "The fill runs live on the LED wall" },
        { id: "artefact", name: "Coded Artefact", role: "Live coding makes the thing launched" },
        { id: "roomgate", name: "Room Gate", role: "First window is people in the room" },
        { id: "cohort", name: "Holder Cohort", role: "Holders delivered named by role" },
      ],
      flow: [
        { id: "onboard", stage: "Onboard", context: "Workshop", action: "Seat scan opens an allocation" },
        { id: "act", stage: "Act", context: "Workshop", action: "Launch page built in the seat" },
        { id: "validate", stage: "Validate", context: "Doors", action: "Presence verified at 22:00" },
        { id: "launch", stage: "Launch", context: "LED wall", action: "The curve opens on the wall" },
        { id: "redeem", stage: "Redeem", context: "Bar", action: "Participation pours the drink" },
        { id: "report", stage: "Report", context: "Post-event", action: "Holder cohort, named by role" },
      ],
    },
  });
