(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      /* @generated:es */
      "mechanics.livelaunch.name": "LANZAMIENTO EN VIVO",
      "mechanics.livelaunch.role": "Un lanzamiento que abre en punto",
      "mechanics.creatordesk.name": "MESA DE CREADOR",
      "mechanics.creatordesk.role": "100 profesionales arman un lanzamiento",
      "mechanics.allocation.name": "ASIGNACIÓN GANADA",
      "mechanics.allocation.role": "La asignación se gana, no se compra",
      "mechanics.curve.name": "LA CURVA",
      "mechanics.curve.role": "El llenado corre en vivo en el muro LED",
      "mechanics.artefact.name": "OBRA EN CÓDIGO",
      "mechanics.artefact.role": "El live coding crea lo que se lanza",
      "mechanics.roomgate.name": "PUERTA DE SALA",
      "mechanics.roomgate.role": "La primera ventana es para quien está",
      "mechanics.cohort.name": "COHORTE DE HOLDERS",
      "mechanics.cohort.role": "Holders entregados con nombre y rol",
      "step.onboard.stage": "Alta",
      "step.onboard.action": "EL ESCANEO DEL ASIENTO ABRE LA ASIGNACIÓN",
      "step.act.stage": "Acción",
      "step.act.action": "PÁGINA DE LANZAMIENTO DESDE EL ASIENTO",
      "step.validate.stage": "Validación",
      "step.validate.action": "PRESENCIA VERIFICADA A LAS 21:00",
      "step.launch.stage": "Lanzamiento",
      "step.launch.action": "LA CURVA ABRE EN EL MURO",
      "step.redeem.stage": "Canje",
      "step.redeem.action": "LA PARTICIPACIÓN PAGA EL TRAGO",
      "step.report.stage": "Reporte",
      "step.report.action": "COHORTE DE HOLDERS, CON NOMBRE Y ROL",
      "nav.brandFunction": "FUNCIÓN DEL LAUNCHPAD",
      "brandFunction.kicker": "FUNCIÓN DEL LAUNCHPAD",
      "brandFunction.title": "UN LANZAMIENTO EN VIVO FRENTE A 100 PERSONAS QUE TRABAJAN EN MÚSICA.",
      "brandFunction.copy": "El taller de las 17:00 sienta a productores, artistas, sellos, managers y estudios, que es exactamente la población para la que se construye un producto de lanzamientos de creador. El launchpad no patrocina esta noche, corre un lanzamiento real dentro de ella, abierto en la sala y llenado por la gente que está sentada ahí.",
      "brandFunction.noLogoWall": "NO ES UN LOGO EN EL BACKDROP DEL ESCENARIO.",
      "brandFunction.distinctFunctions": "SIETE FUNCIONES DE LANZAMIENTO, CADA UNA CON SU PROPIA PARTICIPACIÓN CONTADA.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "LA PARTICIPACIÓN GANA LA ASIGNACIÓN. LA ASIGNACIÓN DEJA REGISTRO.",
      "crossWeek.copy": "Nadie compra su lugar al frente de este lanzamiento. La asignación se gana con una acción validada en la sala, se canjea por un trago en la barra, se ve llenarse en el muro LED y se entrega después como una cohorte de holders con nombre y rol.",
    ...
    zh: {
      ...
      /* @generated:zh */
      "mechanics.livelaunch.name": "现场发行",
      "mechanics.livelaunch.role": "一次准点开盘的发行",
      "mechanics.creatordesk.name": "创作者工位",
      "mechanics.creatordesk.role": "100 位从业者各做一个发行",
      "mechanics.allocation.name": "额度靠参与",
      "mechanics.allocation.role": "额度靠挣，不靠买",
      "mechanics.curve.name": "进度曲线",
      "mechanics.curve.role": "完成进度实时跑在 LED 主屏",
      "mechanics.artefact.name": "代码作品",
      "mechanics.artefact.role": "Live Coding 做出被发行的东西",
      "mechanics.roomgate.name": "在场优先",
      "mechanics.roomgate.role": "首个窗口只给在场的人",
      "mechanics.cohort.name": "持有者画像",
      "mechanics.cohort.role": "交付带行业身份的持有者名单",
      "step.onboard.stage": "开通",
      "step.onboard.action": "扫码入座即开通额度",
      "step.act.stage": "行动",
      "step.act.action": "在座位上做出发行页",
      "step.validate.stage": "核验",
      "step.validate.action": "21:00 核验是否在场",
      "step.launch.stage": "发行",
      "step.launch.action": "曲线在主屏上开盘",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "参与即可换一杯",
      "step.report.stage": "报告",
      "step.report.action": "带身份的持有者名单",
      "nav.brandFunction": "发行平台功能",
      "brandFunction.kicker": "发行平台功能",
      "brandFunction.title": "一场现场发行，面对 100 位以音乐为业的人。",
      "brandFunction.copy": "17:00 的工作坊里坐着制作人、艺术家、厂牌、经纪人和录音棚，而这正是创作者发行类产品要找的那群人。发行平台不是这场活动的赞助方，它在活动内部完成一次真实发行：在现场开盘，由坐在现场的人把它填满。",
      "brandFunction.noLogoWall": "不是舞台背景板上的一个标志。",
      "brandFunction.distinctFunctions": "七项发行功能，每一项都有各自可计数的参与。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "参与换来额度，额度留下记录。",
      "crossWeek.copy": "在这场发行里，没有人能靠钱插到最前面。额度来自现场通过核验的行动，可在吧台兑换一杯饮品，在 LED 主屏上被看着一点点填满，并在活动之后作为一份带行业身份的持有者名单交付。",
