(function () {
  ...
  /* @generated:concepts */
  var mechanics = [
    ["livelaunch", "Live Launch", "A creator from the line-up launches through the platform during the after party, at an announced minute, with the room present. The launch is the event itself, not a link posted the next day.", ["One launch, one window, announced from the stage and from the wall","The first participants are people physically inside Casa Luma","Measured as participants inside the window and what filled in it","The platform is demonstrated by being used, not by being described"], "Lanzamiento en Vivo", "Un creador del line-up lanza a través de la plataforma durante el after, a una hora anunciada y con la sala presente. El lanzamiento es el evento, no un link publicado al día siguiente.", ["Un lanzamiento, una ventana, anunciada desde el escenario y el muro","Los primeros participantes son gente físicamente dentro de Casa Luma","Se mide como participantes dentro de la ventana y cuánto se llenó","La plataforma se demuestra usándola, no describiéndola"], "现场发行", "阵容中的一位创作者在后半场通过该平台完成发行，时间提前公布，全场在座。发行本身就是这场活动，而不是第二天贴出来的一个链接。", ["一次发行、一个窗口，由舞台和主屏同时公布","最早的参与者是人就在 Casa Luma 现场的那批人","以窗口内的参与人数、以及窗口内的完成情况衡量","平台靠被真正使用来证明自己，而不是靠介绍"]],
    ["creatordesk", "Creator Desk", "The 17:00 workshop is hands-on with a chair for every attendee. The exercise is building a launch draft with Claude on the platform, so the room learns the product by shipping something inside it.", ["All 100 seats work through the same flow at the same time","The session runs on the venue screen so nobody is lost mid-step","Support is in the aisle for the step that normally loses people","Measured as drafts created and how many are still live after the night"], "Mesa de Creador", "El taller de las 17:00 es práctico y hay una silla para cada asistente. El ejercicio es construir un lanzamiento con Claude en la plataforma, así que la sala aprende el producto publicando algo dentro de él.", ["Los 100 asientos recorren el mismo flujo al mismo tiempo","La sesión corre en la pantalla del venue, nadie se pierde a media ruta","Hay soporte en el pasillo justo en el paso donde la gente se cae","Se mide como borradores creados y cuántos siguen vivos tras la noche"], "创作者工位", "17:00 的工作坊是动手环节，每位参与者都有一把椅子。练习内容就是用 Claude 在平台上做出一个发行草案，全场通过在产品里真正做出东西来学会这个产品。", ["100 个座位在同一时间走完同一套流程","课程同步在场馆主屏上，没有人会卡在中间某一步","在最容易劝退的那一步，过道里有人现场协助","以创建的草案数量、以及当晚之后仍然存续的数量衡量"]],
    ...
    ["roomgate", "Room Gate", "The opening window is restricted to guests validated by staff at Casa Luma. It widens later, but the founding holders are the people who were actually there.", ["Presence is validated by staff, not by a self-reported address","Workshop attendees who stayed past 21:00 are recognised automatically","Gives the launch a founding cohort that can be described honestly","Measured as in-room participants against the later public window"], "Puerta de Sala", "La ventana de apertura queda restringida a invitados validados por el staff en Casa Luma. Después se abre más, pero los primeros holders son quienes estuvieron ahí.", ["La presencia la valida el staff, no una dirección declarada por el usuario","Quien se quedó del taller después de las 21:00 se reconoce automáticamente","Le da al lanzamiento una cohorte fundadora que se puede describir con honestidad","Se mide como participantes en sala frente a la ventana pública posterior"], "在场优先", "开盘窗口仅对在 Casa Luma 由工作人员核验通过的来宾开放。之后会逐步放开，但最初的持有者是真正到过现场的人。", ["在场由工作人员核验，而不是用户自己填一个地址","21:00 之后仍留在现场的工作坊参与者自动获得识别","让这次发行拥有一批可以如实描述的初始持有人","以现场参与人数、对照之后的公开窗口衡量"]],
  ...
  var rewardFlow = [
    ["onboard", "Seat scan opens an allocation", "Doors at 17:00, 100 chairs, one scan per seat. The scan that seats the guest is the scan that opens their allocation on the launchpad.", ["All 100 seats onboarded in the same block, with staff in the aisle","Role captured at the seat: producer, artist, label, manager, studio","Measured as allocations opened at the seat, not as app installs","Nobody is asked to go and sign up alone later"], "El escaneo del asiento abre la asignación", "Puertas a las 17:00, 100 sillas, un escaneo por asiento. El escaneo que sienta al invitado es el que abre su asignación en la plataforma.", ["Los 100 asientos se dan de alta en el mismo bloque, con staff en el pasillo","El rol se captura en el asiento: productor, artista, sello, manager, estudio","Se mide como asignaciones abiertas en el asiento, no como instalaciones","A nadie se le pide registrarse solo, más tarde"], "扫码入座即开通额度", "17:00 开门，100 把椅子，每个座位扫一次码。让来宾入座的那次扫码，同时也在平台上为他开通了额度。", ["100 个座位在同一时段完成开通，过道里有工作人员","身份在座位上登记：制作人、艺术家、厂牌、经纪人、录音棚","以在座位上开通的额度数衡量，而不是应用安装量","不需要任何人事后独自去注册"]],
    ["act", "Launch page built in the seat", "The hands-on exercise is building a launch on the platform with Claude. Every attendee finishes the 17:00 to 21:00 block having used the product for its actual purpose.", ["The step is done together, mirrored on the venue screen","Artists build for themselves, labels and managers build for a roster","Measured as launch drafts completed inside the workshop block","Product education happens before the room starts drinking"], "Página de lanzamiento desde el asiento", "El ejercicio práctico es construir un lanzamiento en la plataforma con Claude. Cada asistente termina el bloque de 17:00 a 21:00 habiendo usado el producto para lo que sirve.", ["El paso se hace en conjunto, replicado en la pantalla del venue","Los artistas construyen para sí mismos, sellos y managers para su roster","Se mide como borradores de lanzamiento completados dentro del taller","La educación de producto ocurre antes de que la sala empiece a beber"], "在座位上做出发行页", "动手环节就是用 Claude 在平台上做出一个发行。每位参与者结束 17:00 至 21:00 这一段时，都已经把产品用在了它真正的用途上。", ["这一步全场一起做，并同步在场馆主屏上","艺术家为自己做，厂牌和经纪人为旗下艺人做","以工作坊时段内完成的发行草案数量衡量","产品教育发生在全场开始喝酒之前"]],
    ["validate", "Presence verified at 21:00", "At 21:00 the doors open to 120 further guests. Staff verify each guest before allocation is confirmed, so the founding cohort is people who were in the building.", ["Staff validation and the platform record have to agree","Workshop guests who stayed carry their earned tier straight through","Measured as verified participants, kept separate from headcount","This is the number the launch report is built on"], "Presencia verificada a las 21:00", "A las 21:00 las puertas abren para 120 invitados más. El staff verifica a cada invitado antes de confirmar la asignación, así que la cohorte fundadora es gente que estuvo en el lugar.", ["La validación del staff y el registro de la plataforma tienen que coincidir","Quien se quedó del taller conserva directo el nivel que ganó","Se mide como participantes verificados, aparte del conteo de asistentes","Sobre este número se construye el reporte del lanzamiento"], "21:00 核验是否在场", "21:00 开门，另有 120 位来宾进场。工作人员逐一核验后才确认额度，因此初始人群都是真正到过现场的人。", ["人工核验与平台记录必须一致","从工作坊留下来的来宾，直接带着已获得的层级继续","以核验通过的参与者衡量，与到场人数分开统计","发行报告建立在这个数字之上"]],
