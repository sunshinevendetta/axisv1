  ...
  window.FUTURE_RENAISSANCE_ARTISTS = Object.freeze({
    ...
    "the-public": Object.freeze({
      ...
      zh: {
        ...
        bio: "公众之所以列入阵容，是因为作品由整个空间共同完成。每位来宾都将获得一个月免费的 Claude Pro，以及固定 50 美元的 API 额度。任何人带来一张照片或一段视频，或只是使用这个应用，都会在他们站立的当下改变主 LED 墙上运行的视觉。",
        facts: [
          ["角色", "在场的每一位来宾"],
          ["工具", "Claude，呈现在主 LED 墙上"],
          ["包含", "一个月 Claude Pro 与 50 美元 API 额度"],
          ["输出", "随来宾互动而变化的视觉"],
        ],
      },
    }),
