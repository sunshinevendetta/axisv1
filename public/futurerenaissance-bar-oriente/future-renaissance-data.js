(function () {
  ...
  window.FUTURE_RENAISSANCE_ARTISTS = Object.freeze({
    "verse-works": Object.freeze({
      ...
      identity: "FUTURE RENAISSANCE LINE UP",
      bio: "Digital artist on the Future Renaissance digital art line up at Bar Oriente.",
      handle: "",
      href: "",
      linkLabel: "",
    }),
    ...
    "the-public": Object.freeze({
      ...
      identity: "FUTURE RENAISSANCE LINE UP",
      bio: "The public is billed as part of the line up because the room makes the work. Everyone attending receives a free month of the Claude Pro plan plus a fixed 50 USD in API credits, and any guest who brings photos or video, or simply interacts with the application, alters the visual experience running in real time on the main LED wall.",
      handle: "",
      href: "",
      linkLabel: "",
    }),
