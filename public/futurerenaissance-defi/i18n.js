(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      "brandFunction.title": "UNA POSICIÓN ABIERTA A LAS 18:00 Y CERRADA ANTES DE QUE SE VACÍE LA SALA.",
      "brandFunction.copy": "Un protocolo no compra un logo arriba de la barra. Recibe tres horas sentadas en las que un invitado lee los términos, deposita con alguien al lado, ve correr la posición y la cierra esa misma noche.",
    ...
    zh: {
      ...
      "brandFunction.title": "18:00 开出的仓位，在人群散场之前平掉。",
      "brandFunction.copy": "协议合作方买到的不是吧台上方的一个标志，而是三个小时的座席时间：来宾读完条款，在有人陪同下完成存入，看着仓位运行整晚，并在同一个晚上把它关闭。",
