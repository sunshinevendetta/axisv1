(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      "mechanics.deposit.role": "Primera posición abierta con personal",
      "mechanics.terms.name": "TÉRMINOS",
      "mechanics.terms.role": "La hoja de riesgos, antes de depositar",
      "mechanics.accrue.name": "ACUMULAR",
      "mechanics.accrue.role": "Una posición que corre toda la noche",
      "mechanics.settle.name": "LIQUIDAR",
      "mechanics.settle.role": "Posiciones cerradas en el closing DJ",
      "mechanics.bartab.name": "CUENTA DE BARRA",
      "mechanics.bartab.role": "La liquidación es lo que abre la cuenta",
      "mechanics.claim.name": "RECLAMAR",
      "mechanics.claim.role": "Recompensas reclamadas antes de salir",
      "mechanics.withdraw.name": "RETIRAR",
      "mechanics.withdraw.role": "Nadie se va con la posición abierta",
      "step.onboard.stage": "ONBOARDING",
      "step.onboard.action": "DEPÓSITO ABIERTO EN LOS ASIENTOS",
      "step.act.stage": "ACCIÓN",
      "step.act.action": "TÉRMINOS LEÍDOS Y DEPÓSITO HECHO",
      "step.validate.stage": "VALIDACIÓN",
      "step.validate.action": "POSICIÓN VERIFICADA EN CADENA",
      "step.redeem.stage": "REDENCIÓN",
      "step.redeem.action": "LA POSICIÓN LIQUIDADA ABRE LA CUENTA",
      "step.close.stage": "CIERRE",
      "step.close.action": "RECLAMAR, RETIRAR Y SALIR",
      "step.report.stage": "REPORTE",
      "step.report.action": "CADA POSICIÓN EN EL REPORTE",
      "nav.brandFunction": "FUNCIÓN DEFI",
      "brandFunction.kicker": "FUNCIÓN DEFI",
      "brandFunction.title": "UNA POSICIÓN ABIERTA A LAS 17:00 Y CERRADA ANTES DE QUE SE VACÍE LA SALA.",
      "brandFunction.copy": "Un protocolo no compra un logo arriba de la barra. Recibe cuatro horas sentadas en las que un invitado lee los términos, deposita con alguien al lado, ve correr la posición y la cierra esa misma noche.",
      "brandFunction.noLogoWall": "NO ES UN LOGO ARRIBA DE LA BARRA.",
      "brandFunction.distinctFunctions": "UN EMBUDO COMPLETO DE DEPÓSITO A RETIRO, CONTADO POSICIÓN POR POSICIÓN.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "UN DEPÓSITO SE VUELVE UN TRAGO Y LUEGO UNA LÍNEA EN EL REPORTE.",
      "crossWeek.copy": "Depósito guiado por personal, posición verificada, trago redimido en la barra, el conteo de ciclos completos en el muro LED principal y después un reporte donde cada posición está contabilizada. Una dinámica de regalos termina cuando se entrega el premio; esto termina en un documento.",
    ...
    zh: {
      ...
      /* @generated:zh */
      "mechanics.deposit.name": "存入",
      "mechanics.deposit.role": "在有人协助下完成首次开仓",
      "mechanics.terms.name": "条款",
      "mechanics.terms.role": "存入之前先读完风险页",
      "mechanics.accrue.name": "累积",
      "mechanics.accrue.role": "一个持续整晚的仓位",
      "mechanics.settle.name": "结算",
      "mechanics.settle.role": "闭场 DJ 时段统一平仓",
      "mechanics.bartab.name": "吧台账单",
      "mechanics.bartab.role": "结算结果才是开单的凭据",
      "mechanics.claim.name": "领取",
      "mechanics.claim.role": "离场前领取协议奖励",
      "mechanics.withdraw.name": "提取",
      "mechanics.withdraw.role": "没有人带着未平仓位回家",
      "step.onboard.stage": "引导",
      "step.onboard.action": "在座位上完成开仓",
      "step.act.stage": "行动",
      "step.act.action": "读完条款后完成存入",
      "step.validate.stage": "验证",
      "step.validate.action": "链上确认仓位",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "已结算的仓位开启账单",
      "step.close.stage": "收尾",
      "step.close.action": "领取、提取、离场",
      "step.report.stage": "报告",
      "step.report.action": "每一个仓位都进入报告",
      "nav.brandFunction": "DEFI 功能",
      "brandFunction.kicker": "DEFI 功能",
      "brandFunction.title": "17:00 开出的仓位，在人群散场之前平掉。",
      "brandFunction.copy": "协议合作方买到的不是吧台上方的一个标志，而是四个小时的座席时间：来宾读完条款，在有人陪同下完成存入，看着仓位运行整晚，并在同一个晚上把它关闭。",
      "brandFunction.noLogoWall": "不是吧台上方的一个标志。",
      "brandFunction.distinctFunctions": "一条从存入到提取的完整漏斗，逐个仓位计数。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "一次存入变成一杯酒，再变成报告里的一行。",
      "crossWeek.copy": "有人引导的存入、经过验证的仓位、在吧台兑换的酒、主 LED 墙上的闭环计数，最后是一份每个仓位都有交代的报告。抽奖在奖品送出的那一刻结束，这条链路的终点是一份文件。",
      "crossWeek.note": "仅为示例流程 · 具体行动将围绕该协议设计。",
    /* @end */
    }
  };
