(function () {
  ...
  /* @generated:concepts */
  var mechanics = [
    ["deposit", "Deposit", "The first deposit is made at a staffed onboarding point inside the workshop, with a host beside the guest for the step that normally happens alone at one in the morning.", ["Opened during the 17:00 to 21:00 workshop, from a seat rather than a crowded bar","Staff present for wallet connection, network, approval and confirmation","A failed or stuck transaction is diagnosed in the room instead of abandoned","Measured as first-time deposits completed on site and median first deposit size"], "Depositar", "El primer depósito se hace en un punto de onboarding con personal dentro del taller, con un anfitrión al lado en el paso que normalmente ocurre solo a la una de la mañana.", ["Se abre durante el taller de 17:00 a 21:00, sentado y sin prisa","Personal presente para conectar wallet, red, aprobación y confirmación","Una transacción fallida se resuelve en la sala en vez de abandonarse","Se mide como primeros depósitos completados en sitio y monto mediano"], "存入", "首次存入在工作坊内由工作人员值守的引导点完成，通常凌晨独自面对的那一步，这里有人站在旁边。", ["在 17:00 至 21:00 的工作坊期间完成，坐着操作而非挤在吧台","钱包连接、网络、授权与确认全程有人协助","交易失败当场排查，而不是就此放弃","以现场完成的首次存入数与存入金额中位数计量"]],
    ["terms", "Terms", "Four seated hours are the rare window where somebody will actually read what they are depositing into. Staff walk the risk and terms page before any confirmation is taken.", ["Lock-up, fees, smart-contract risk and withdrawal conditions said out loud","The explainer runs on the venue screen during the workshop block","No confirmation is accepted from a guest who has not been through it","Measured as terms walkthroughs completed against deposits opened"], "Términos", "Cuatro horas sentado son la ventana rara en la que alguien de verdad lee en qué está depositando. El personal recorre la hoja de riesgos y términos antes de cualquier confirmación.", ["Bloqueo, comisiones, riesgo de contrato y condiciones de retiro dichos en voz alta","El explicador corre en la pantalla del venue durante el taller","No se acepta confirmación de quien no pasó por ahí","Se mide como recorridos de términos completados frente a depósitos abiertos"], "条款", "四小时的座席时间，是极少数有人会真正读清自己存入了什么的窗口。任何确认之前，工作人员会逐条讲解风险与条款页。", ["锁定期、费用、合约风险与提取条件都会当众讲明","讲解内容在工作坊时段于场地屏幕上同步呈现","未完成讲解的来宾不会被接受确认","以完成条款讲解的人数与已开仓位数对照计量"]],
    ["accrue", "Accrue", "The position stays open from the workshop through the live coding set to the closing DJ, so the guest spends the night with the thing they read about actually doing something.", ["Opened before 21:00 and visible on the guest's own phone all night","Guests check it between the warm-up DJ and the live coding set","No projected figure and no rate is shown, quoted or promised at any point","Measured as positions still open when the night opens at 21:00"], "Acumular", "La posición queda abierta desde el taller, pasa por el set de live coding y llega al closing DJ, así que el invitado pasa la noche con eso que leyó haciendo algo real.", ["Abierta antes de las 21:00 y visible en su propio teléfono toda la noche","Los invitados la revisan entre el DJ de apertura y el live coding","No se muestra ni se promete ninguna cifra ni tasa proyectada","Se mide como posiciones aún abiertas cuando se abren las puertas a las 21:00"], "累积", "仓位从工作坊一直保持到 live coding 与闭场 DJ，来宾整晚都能看到自己读过的东西真的在运行。", ["21:00 前开仓，整晚可在自己手机上查看","来宾会在暖场 DJ 与 live coding 之间反复查看","全程不展示、不引用、不承诺任何收益率或预估数字","以 21:00 夜场开场时仍然持仓的数量计量"]],
    ...
    ["withdraw", "Withdraw", "Withdrawal is completed before the guest leaves Casa Luma. A position opened and closed the same night is a complete, honest funnel rather than an abandoned one.", ["Deposit, hold, settle and withdraw all inside a single night","Principal back in the guest's own custody before they walk out","A guest who chooses to keep the position open does so knowingly and on record","Measured as withdrawals completed and positions left open at close"], "Retirar", "El retiro se completa antes de que el invitado salga de Casa Luma. Una posición abierta y cerrada la misma noche es un embudo completo y honesto, no uno abandonado.", ["Depositar, mantener, liquidar y retirar dentro de una sola noche","El principal vuelve a su custodia antes de que salga por la puerta","Quien decide dejar la posición abierta lo hace a conciencia y queda registrado","Se mide como retiros completados y posiciones abiertas al cierre"], "提取", "提取在来宾离开 Casa Luma 之前完成。同一晚开仓又平仓，是一个完整而诚实的漏斗，而不是一个被遗弃的仓位。", ["存入、持有、结算、提取，全部发生在同一个晚上","本金在来宾走出场地之前回到他们自己手中","选择继续持仓的人是在知情前提下决定，并留下记录","以完成的提取数与闭场时仍未平的仓位数计量"]],
  ];
  ...
  var rewardFlow = [
    ["onboard", "Deposit opened at the seats", "Between 17:00 and 21:00 the deposit point works the seated room row by row while the workshop runs on the venue screen.", ["100 seated attendees from the music industry, a chair for every one of them","Staff-guided: wallet, network and first approval handled in person","The quietest, most attentive onboarding window of the night","Measured as guests onboarded against seats filled"], "Depósito abierto en los asientos", "Entre las 17:00 y las 21:00 el punto de depósito recorre la sala sentada fila por fila mientras el taller corre en la pantalla del venue.", ["100 asistentes sentados de la industria musical, una silla para cada uno","Flujo guiado: wallet, red y primera aprobación resueltas en persona","La ventana de onboarding más tranquila y atenta de la noche","Se mide como invitados onboardeados frente a asientos ocupados"], "在座位上完成开仓", "17:00 至 21:00，存入点位沿着座席一排排推进，工作坊同时在场地屏幕上进行。", ["100 位来自音乐行业的座席来宾，每人一把椅子","全程有人引导：钱包、网络与首次授权都在现场完成","这是当晚最安静、注意力最集中的引导窗口","以完成引导的来宾数与实际座席数对照计量"]],
