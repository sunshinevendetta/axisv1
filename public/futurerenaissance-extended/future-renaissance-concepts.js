(function () {
  ...
  add("venue", "03 / VENUE", "Mexa Cocina del Alma", "The host venue: the physical operating layer where culture, hospitality, activities, media and AI interaction meet.", [
    "October 28, 2026 · Mexico City",
    "Av. Álvaro Obregón 180, Roma Norte, Cuauhtémoc, 06700 Ciudad de México, CDMX",
  ...
  add("close-event-partner", "11 / THE NIGHT", "Future Renaissance", "One night at Mexa Cocina del Alma, October 28, 2026: a Claude community workshop for the music industry, and then the night.", [
    "200 seated for the workshop, then 250 more for the night",
  ...
  var formatDefinitions = {
    ...
    "format-mapping": ["Video mapping", "Projected imagery extends the Future Renaissance visual world through Mexa Cocina del Alma.", ["Venue-specific treatment", "Brand integration where useful", "Live visual moments", "Capture-ready output"]],
  ...
  var systemDefinitions = {
    ...
    "system-arrive": ["Guests arrive", "Access and role states are established as the guest enters Mexa Cocina del Alma."],
  ...
  add("community-status", "09 / STATUS", "Mexico City | Claude for Music", "A Claude community event: a seated, hands-on workshop for the music industry, organized by Claude community ambassadors and produced by AXIS.", [
    ...
    "Host venue: Mexa Cocina del Alma, Av. Álvaro Obregón 180, Roma Norte, Cuauhtémoc, 06700 Ciudad de México, CDMX",
  ...
  (function () {
    addI18n("venue", "es", "Mexa Cocina del Alma", "El venue es la capa operativa física donde convergen la cultura, la hospitalidad, las actividades, los medios y la interacción con IA.", [
    ...
    addI18n("venue", "zh", "Mexa Cocina del Alma", "场地是文化、款待、活动、媒体和 AI 互动交汇的物理运营层。", [
      "2026年10月28日 · 墨西哥城",
      "Av. Álvaro Obregón 180, Roma Norte, Cuauhtémoc, 06700 Ciudad de México, CDMX",
  ...
  (function () {
    ...
    addI18n("close-event-partner", "es", "Future Renaissance", "Una noche en Mexa Cocina del Alma, 28 de octubre de 2026: un workshop de la comunidad de Claude para la industria musical, y después la noche.", [
    ...
    addI18n("close-event-partner", "zh", "Future Renaissance", "2026 年 10 月 28 日，Mexa Cocina del Alma 的这一夜：一场为音乐行业举办的 Claude 社区工作坊，随后是当晚。", [
  ...
  (function () {
    ...
    addI18n("community-status", "es", "Mexico City | Claude for Music", "Un evento de la comunidad de Claude: un workshop práctico y sentado para la industria musical, organizado por embajadores de la comunidad de Claude y producido por AXIS.", ["Mexico Tech Week 2026, Ciudad de México","200 asistentes sentados, de 18:00 a 21:00","Sede anfitriona: Mexa Cocina del Alma, Av. Álvaro Obregón 180, Roma Norte, Cuauhtémoc, 06700 Ciudad de México, CDMX","Registro en Luma, con aprobación previa, a cargo de los organizadores"]);
    ...
    addI18n("community-status", "zh", "MEXICO CITY | CLAUDE FOR MUSIC", "一场 Claude 社区活动：为音乐行业举办的坐式实操工作坊，由 Claude 社区大使组织，由 AXIS 制作。", ["2026 年墨西哥科技周，墨西哥城","200 位坐式参与者，18:00 至 21:00","主办场地：Mexa Cocina del Alma，Av. Álvaro Obregón 180, Roma Norte, Cuauhtémoc, 06700 Ciudad de México, CDMX","在 Luma 报名，需审核，由主办方管理"]);
  ...
  (function () {
    ...
    addI18n("format-mapping", "es", "Video mapping", "Las imágenes proyectadas extienden el universo visual de Future Renaissance a través de Mexa Cocina del Alma.", ["Tratamiento específico para el venue", "Integración de marca cuando resulte útil", "Momentos visuales en vivo", "Resultado listo para captura"]);
    ...
    addI18n("format-mapping", "zh", "光雕投影", "投影影像将 Future Renaissance 的视觉世界延伸至整个 Mexa Cocina del Alma。", ["针对场地定制的处理方式", "在适当时机融入品牌元素", "现场视觉时刻", "可直接用于拍摄记录的成片"]);
  ...
  (function () {
    ...
    addI18n("system-arrive", "es", "Los invitados llegan", "Los estados de acceso y rol se establecen cuando el invitado ingresa a Mexa Cocina del Alma.", systemDetailsEs);
    ...
    addI18n("system-arrive", "zh", "宾客抵达", "宾客进入 Mexa Cocina del Alma 时，系统建立访问权限和角色状态。", systemDetailsZh);
