(function () {
  ...
  window.FUTURE_RENAISSANCE = Object.freeze({
    ...
    venue: "Mexa Cocina del Alma",
    venueSlug: "mexa",
    city: "Mexico City",
    slug: "/futurerenaissance-extended",
    attendees: 250,
  ...
  window.FUTURE_RENAISSANCE_ARTISTS = Object.freeze({
    "verse-works": Object.freeze({
      ...
      facts: [
        ...
        ["AT MEXA COCINA DEL ALMA", "Generative works on the venue screens"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN MEXA COCINA DEL ALMA", "Obra generativa en las pantallas"],
        ],
      },
      zh: {
        kind: "平台",
        ...
        facts: [
          ...
          ["创立", "2022 · 伦敦"],
          ["形式", "长格式生成艺术，由哈希值生成"],
          ["在 MEXA COCINA DEL ALMA", "生成作品在场地屏幕上运行"],
        ],
      },
    }),
    pixelord: Object.freeze({
      name: "Pixelord",
      monogram: "PX",
      monogramMedia: Object.freeze({ type: "image", src: "/futurerenaissance-extended/pixelord.jpg", alt: "Pixelord" }),
      kind: "ARTIST",
      tag: "ARTIST",
      ...
      facts: [
        ...
        ["AT MEXA COCINA DEL ALMA", "Digital work in the line up"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN MEXA COCINA DEL ALMA", "Obra digital en el line up"],
        ],
      },
      zh: {
        kind: "艺术家",
        ...
        facts: [
          ...
          ["在 MEXA COCINA DEL ALMA", "Future Renaissance 阵容中的数字作品"],
        ],
      },
    }),
