(function () {
  ...
  var TEXT = {
    en: {},
    es: {
      "nav.axis-operates": "QUÉ OPERA AXIS",
      "claude.host": "GRUPO ANFITRIÓN: ARCHIPIÉLAGO",
      "claude.organizers": "UN EVENTO DE LA COMUNIDAD ORGANIZADO POR EMBAJADORES DE LA COMUNIDAD DE CLAUDE",
      "workshop.asksLabel": "LO QUE EL WORKSHOP NECESITA DEL VENUE",
      "workshop.runOfShow": "ORDEN DE LA NOCHE",
      "workshop.phaseNightNote": "Las puertas abren de nuevo a las 22:00 para 250 invitados más, además de los asistentes que se quedan.",
      "workshop.phaseNight": "AFTER PARTY",
      "workshop.phaseSeatedNote": "Una silla para cada asistente, y la pantalla del venue llevando la sesión.",
      "workshop.phaseSeated": "WORKSHOP SENTADO",
      "workshop.copy": "Tres horas sentados, hechas para quienes trabajan en música. Productores, artistas, sellos, managers y estudios trabajan de forma práctica con Claude, guiados desde la pantalla al frente del salón. Al cerrar, el salón se convierte en la noche.",
      "workshop.title": "UN WORKSHOP PRÁCTICO PARA LA INDUSTRIA MUSICAL.",
      "workshop.kicker": "EVENTO DE LA COMUNIDAD DE CLAUDE",
      "event.afterParty": "AFTER PARTY",
      "event.seatedWorkshop": "WORKSHOP SENTADO",
      "nav.workshop": "EL WORKSHOP",
      ...
      "event.status": "EVENTO DE LA COMUNIDAD DE CLAUDE · MEXICO TECH WEEK 2026 · GRUPO ANFITRIÓN: ARCHIPIÉLAGO · VENUE DEL GRUPO POR CONFIRMAR",
      ...
      "claude.kicker": "MEXICO CITY | CLAUDE FOR MUSIC",
      "claude.title": "UN WORKSHOP DE LA COMUNIDAD DE CLAUDE PARA LA INDUSTRIA MUSICAL.",
      "venue.kicker": "GRUPO + VENUE",
      "venue.definition": "Archipiélago es un grupo, no un solo espacio, así que la primera pregunta es qué venue del grupo recibe la noche. Las zonas de abajo son un flujo de experiencia propuesto y son conceptuales hasta confirmar ese venue y su inventario técnico.",
      ...
      "close.kicker": "FUTURE RENAISSANCE CON ARCHIPIÉLAGO",
      "close.official": "WORKSHOP DE LA COMUNIDAD DE CLAUDE, Y DESPUÉS LA NOCHE",
      "close.hospitality": "HOSPITALIDAD DE CORTESÍA",
      "close.hospitalityValue": "FINANCIADA POR AXIS",
    },
    zh: {
      "nav.axis-operates": "AXIS 负责什么",
      "claude.host": "主办团体：ARCHIPIÉLAGO",
      "claude.organizers": "由 CLAUDE 社区大使组织的社区活动",
      "workshop.asksLabel": "工作坊需要场地配合的事项",
      "workshop.runOfShow": "当晚流程",
      "workshop.phaseNightNote": "22:00 再次开门，另有 250 位宾客到场，再加上留下来的参与者。",
      "workshop.phaseNight": "派对环节",
      "workshop.phaseSeatedNote": "每位参与者都有座位，场地屏幕承载整场课程。",
      "workshop.phaseSeated": "坐式工作坊",
      "workshop.copy": "三小时的坐式课程，专为从事音乐工作的人而设。制作人、艺术家、厂牌、经纪人与录音室将在前方屏幕的引导下，与 Claude 实操协作。工作坊结束后，这个空间就变成了当晚。",
      "workshop.title": "为音乐行业打造的实操工作坊。",
      "workshop.kicker": "CLAUDE 社区活动",
      "event.afterParty": "派对环节",
      "event.seatedWorkshop": "坐式工作坊",
      "nav.workshop": "工作坊",
      ...
      "event.status": "CLAUDE 社区活动 · 墨西哥科技周 2026 · 主办团体：ARCHIPIÉLAGO · 具体场地待定",
      ...
      "claude.kicker": "MEXICO CITY | CLAUDE FOR MUSIC",
      "claude.title": "为音乐行业举办的 CLAUDE 社区工作坊。",
      "venue.kicker": "团体与场地",
      "venue.definition": "Archipiélago 是一个集团，而非单一空间，因此首先要确定由旗下哪个场地承办当晚。下方分区是提议的体验流程，在该场地及其技术清单确认前仅为概念性安排。",
      ...
      "close.kicker": "FUTURE RENAISSANCE · ARCHIPIÉLAGO",
      "close.official": "CLAUDE 社区工作坊，随后是当晚",
