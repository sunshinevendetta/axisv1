(function () {
  ...
  window.FUTURE_RENAISSANCE = Object.freeze({
    ...
    venue: "Archipiélago",
    venueSlug: "archipielago",
    city: "Mexico City",
    slug: "/futurerenaissance-archipielago",
    attendees: 250,
  ...
  window.FUTURE_RENAISSANCE_ARTISTS = Object.freeze({
    "verse-works": Object.freeze({
      ...
      facts: [
        ...
        ["ON THE NIGHT", "Generative works on the venue screens"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN LA NOCHE", "Obra generativa en las pantallas"],
        ],
      },
      zh: {
        kind: "平台",
    ...
    pixelord: Object.freeze({
      name: "Pixelord",
      monogram: "PX",
      monogramMedia: Object.freeze({ type: "image", src: "/futurerenaissance-archipielago/pixelord.jpg", alt: "Pixelord" }),
      kind: "ARTIST",
      tag: "ARTIST",
      ...
      facts: [
        ...
        ["ON THE NIGHT", "Digital work in the line up"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN LA NOCHE", "Obra digital en el line up"],
        ],
      },
      zh: {
        kind: "艺术家",
        ...
        facts: [
          ...
          ["当晚", "Future Renaissance 阵容中的数字作品"],
        ],
      },
    }),
