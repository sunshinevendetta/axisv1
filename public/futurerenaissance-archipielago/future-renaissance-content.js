(function () {
  ...
  var root = "/futurerenaissance-archipielago/brand-assets/axis_future_renaissance_brand_assets";
  var orientation = document.documentElement.dataset.orientation || "horizontal";
  var poster = orientation === "vertical"
    ? "/futurerenaissance-archipielago/poster-vertical.png"
    : "/futurerenaissance-archipielago/poster-horizontal.png";
  ...
  var formatGroups = [
    { key: "a", letter: "A", title: "CULTURE", items: [
      ...
      [null, "VIDEO MAPPING", "Projected visuals authored for the host venue.", "projector"],
    ] },
  ...
  var slides = [
    ...
    '<section class="fr-slide fr-event" data-slide-id="event" data-scene="event-map" data-label="The event">' +
      ...
      '<div class="fr-reading event-heading">' +
        ...
        '<p class="event-status" data-reveal data-i18n="event.status">CLAUDE COMMUNITY EVENT · MEXICO TECH WEEK 2026 · HOST GROUP: ' + event.venue.toUpperCase() + ' · VENUE WITHIN THE GROUP TO BE CONFIRMED</p>' +
      '</div>' +
    ...
    '<section class="fr-slide fr-presenting claude-slide" data-slide-id="presenting" data-scene="claude-stream" data-label="Claude community event">' +
      ...
      '<div class="claude-body">' +
        '<div class="claude-copy">' +
          ...
          '<p class="claude-host" data-reveal data-i18n="claude.host">HOST GROUP: ' + event.venue.toUpperCase() + '</p>' +
        '</div>' +
    ...
    '<section class="fr-slide fr-signature" data-slide-id="signature" data-scene="signature-product" data-label="Future Renaissance at the venue">' +
      frameTop("14", "venue") +
      '<div class="signature-heading"><span class="eyebrow" data-reveal data-i18n="venue.kicker">GROUP + VENUE</span><h2 data-reveal>FUTURE RENAISSANCE<br>WITH ' + event.venue.toUpperCase() + '.</h2><p data-reveal data-i18n="venue.definition">Archipiélago is a group, not a single room, so the first ask is which venue in the group hosts the night. The zones below are a proposed experience flow and stay conceptual until that venue and its technical inventory are confirmed.</p></div>' +
    ...
    '<section class="fr-slide fr-close" data-slide-id="close" data-scene="closing" data-label="Close">' +
      ...
      '<div class="close-panel" data-decode>' +
        ...
        '<span class="eyebrow" data-reveal data-i18n="close.kicker">FUTURE RENAISSANCE WITH ' + event.venue.toUpperCase() + '</span>' +
