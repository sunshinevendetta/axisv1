(function () {
  ...
  var slides = [
    ...
    /* @generated:slides */
    '<section class="fr-slide frx-brand-function" data-slide-id="brand-function" data-scene="structured" data-label="Wallet function">' +
      frameTop("08", "brandFunction", "WALLET FUNCTION") +
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="brandFunction.kicker">WALLET FUNCTION</span><h2 data-reveal data-i18n="brandFunction.title">SEVEN MOMENTS IN ONE NIGHT WHERE THE WALLET IS THE ONLY THING THAT WORKS.</h2><p data-reveal data-i18n="brandFunction.copy">A wallet partner does not buy a logo above the bar. For one evening the wallet is the credential at the door, the signature that validates a mission, the thing that opens a drink, and the only address still reachable the next morning.</p></div>' +
      '<div class="frx-function-grid" data-crystallize>' + focus.mechanics.map(mechanicCard).join("") + '</div>' +
      '<div class="frx-brand-rule" data-reveal><span data-i18n="brandFunction.noLogoWall">NOT A LOGO ABOVE THE BAR.</span><strong data-i18n="brandFunction.distinctFunctions">SEVEN WALLET MOMENTS, EACH WITH ITS OWN MEASURABLE COMPLETION.</strong></div>' +
    '</section>',
    ...
    '<section class="fr-slide frx-cross-week" data-slide-id="reward-flow" data-scene="structured" data-label="The reward flow">' +
      ...
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="crossWeek.kicker">THE REWARD FLOW</span><h2 data-reveal data-i18n="crossWeek.title">A CONNECTED WALLET BECOMES A DRINK BECOMES A REPORTED NUMBER.</h2><p data-reveal data-i18n="crossWeek.copy">A basic giveaway is passive and ends the moment the prize is handed over. This chain runs from the door to the bar to the post-event report, and every step leaves a record the partner can read.</p></div>' +
      '<div class="frx-week-sequence" data-crystallize>' + focus.flow.map(flowCard).join("") + '</div>' +
      '<div class="frx-example-note" data-reveal data-i18n="crossWeek.note">EXAMPLE FLOW · EXACT ACTIONS ARE DESIGNED AROUND THE WALLET PRODUCT.</div>' +
    '</section>',
    /* @end */
