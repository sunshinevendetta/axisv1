(function () {
  ...
  window.FUTURE_RENAISSANCE = deepFreeze({
    ...
    productFocus: {
      ...
      name: "Wallet",
      slot: "[WALLET BRAND]",
      discipline: "Self-custody wallet, identity and claim flow",
      mechanics: [
        { id: "connect", name: "Connect", role: "The door scan opens the wallet, not a form" },
        { id: "passport", name: "Passport", role: "The mission passport lives in the wallet" },
        { id: "sign", name: "Sign", role: "A signature, not a promoter's word" },
        { id: "fund", name: "Fund", role: "First balance during the seated workshop" },
        { id: "collect", name: "Collect", role: "The night's artefact is held, not screenshotted" },
        { id: "redeem", name: "Redeem", role: "The wallet opens the bar tab" },
        { id: "keep", name: "Keep", role: "The only address still live tomorrow" },
      ],
      flow: [
        { id: "onboard", stage: "Onboard", context: "Doors", action: "Wallet connected at entry" },
        { id: "act", stage: "Act", context: "Workshop", action: "First signed action" },
        { id: "validate", stage: "Validate", context: "Floor", action: "Staff and signature agree" },
        { id: "redeem", stage: "Redeem", context: "Bar", action: "Drink unlocked from the wallet" },
        { id: "screen", stage: "Screen", context: "LED wall", action: "Collected work on the wall" },
        { id: "report", stage: "Report", context: "Post-event", action: "Addresses, actions, redemptions" },
      ],
    },
  });
