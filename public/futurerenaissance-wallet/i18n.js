(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      "mechanics.connect.role": "El escaneo de entrada abre la wallet, no un formulario",
      "mechanics.passport.name": "PASAPORTE",
      "mechanics.passport.role": "El pasaporte de misiones vive en la wallet",
      "mechanics.sign.name": "FIRMAR",
      "mechanics.sign.role": "Una firma, no la palabra del promotor",
      "mechanics.fund.name": "FONDEAR",
      "mechanics.fund.role": "Primer saldo durante el workshop sentado",
      "mechanics.collect.name": "COLECCIONAR",
      "mechanics.collect.role": "La obra de la noche se guarda, no se captura",
      "mechanics.redeem.name": "CANJEAR",
      "mechanics.redeem.role": "La wallet abre la cuenta de la barra",
      "mechanics.keep.name": "CONSERVAR",
      "mechanics.keep.role": "La única dirección viva mañana",
      "step.onboard.stage": "Onboarding",
      "step.onboard.action": "WALLET CONECTADA EN LA ENTRADA",
      "step.act.stage": "Actuar",
      "step.act.action": "PRIMERA ACCIÓN FIRMADA",
      "step.validate.stage": "Validar",
      "step.validate.action": "STAFF Y FIRMA COINCIDEN",
      "step.redeem.stage": "Canjear",
      "step.redeem.action": "BEBIDA DESBLOQUEADA DESDE LA WALLET",
      "step.screen.stage": "Pantalla",
      "step.screen.action": "OBRA COLECCIONADA EN EL MURO",
      "step.report.stage": "Reporte",
      "step.report.action": "DIRECCIONES, ACCIONES, CANJES",
      "nav.brandFunction": "FUNCIÓN DE LA WALLET",
      "nav.crossWeek": "EL FLUJO DE RECOMPENSA",
      "brandFunction.kicker": "FUNCIÓN DE LA WALLET",
      "brandFunction.title": "SIETE MOMENTOS EN UNA NOCHE EN LOS QUE LA WALLET ES LO ÚNICO QUE FUNCIONA.",
      "brandFunction.copy": "Un partner de wallet no compra un logo arriba de la barra. Por una noche la wallet es la credencial en la puerta, la firma que valida una misión, lo que abre una bebida y la única dirección que sigue disponible a la mañana siguiente.",
      "brandFunction.noLogoWall": "NO ES UN LOGO ARRIBA DE LA BARRA.",
      "brandFunction.distinctFunctions": "SIETE MOMENTOS DE WALLET, CADA UNO CON SU PROPIA FINALIZACIÓN MEDIBLE.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "UNA WALLET CONECTADA SE VUELVE UNA BEBIDA Y LUEGO UNA CIFRA REPORTADA.",
      "crossWeek.copy": "Un giveaway básico es pasivo y termina en cuanto se entrega el premio. Esta cadena va de la puerta a la barra y al reporte post-evento, y cada paso deja un registro que el partner puede leer.",
      "crossWeek.note": "FLUJO DE EJEMPLO · LAS ACCIONES EXACTAS SE DISEÑAN SEGÚN EL PRODUCTO WALLET.",
    /* @end */
    },
    zh: {
      "nav.proposition": "提案",
      ...
      "mechanics.connect.role": "入场扫码打开的是钱包，不是表单",
      "mechanics.passport.name": "任务护照",
      "mechanics.passport.role": "任务护照存放在钱包中",
      "mechanics.sign.name": "签名",
      "mechanics.sign.role": "凭签名，而非主办方的口头认定",
      "mechanics.fund.name": "注资",
      "mechanics.fund.role": "在落座工作坊期间完成首次入金",
      "mechanics.collect.name": "收藏",
      "mechanics.collect.role": "当晚的作品被保存，而不是被截图",
      "mechanics.redeem.name": "兑换",
      "mechanics.redeem.role": "用钱包开启吧台账单",
      "mechanics.keep.name": "留存",
      "mechanics.keep.role": "明天唯一仍然有效的地址",
      "step.onboard.stage": "引导",
      "step.onboard.action": "入口完成钱包连接",
      "step.act.stage": "行动",
      "step.act.action": "首次签名行动",
      "step.validate.stage": "验证",
      "step.validate.action": "人工与签名一致",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "用钱包解锁一杯酒",
      "step.screen.stage": "屏幕",
      "step.screen.action": "收藏的作品出现在墙上",
      "step.report.stage": "报告",
      "step.report.action": "地址、行为、兑换",
      "nav.brandFunction": "钱包功能",
      "nav.crossWeek": "奖励流程",
      "brandFunction.kicker": "钱包功能",
      "brandFunction.title": "一个夜晚里的七个时刻，只有钱包才能完成。",
      "brandFunction.copy": "钱包合作方买到的不是吧台上方的一个标志。在这一晚，钱包是门口的凭证、验证任务的签名、开启一杯酒的方式，也是第二天清晨唯一仍可触达的地址。",
      "brandFunction.noLogoWall": "不是吧台上方的一个标志。",
      "brandFunction.distinctFunctions": "七个钱包时刻，每一个都有各自可衡量的完成标准。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "一个连接好的钱包，变成一杯酒，再变成一个可报告的数字。",
      "crossWeek.copy": "普通的赠品是被动的，礼物递出的那一刻就结束了。这条链路从门口延伸到吧台，再到活动后的报告，每一步都留下合作方可以读取的记录。",
      "crossWeek.note": "示例流程 · 具体行动将围绕该钱包产品设计。",
    /* @end */
    }
  };
