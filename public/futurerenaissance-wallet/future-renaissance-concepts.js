(function () {
  ...
  var mechanics = [
    ...
    ["fund", "Fund", "The hardest step in any wallet funnel is the first funded balance. The four seated hours are the rare window where someone will actually finish it.", ["A staffed onboarding point runs through the 17:00–21:00 workshop","Support is physically present for the step that usually drops off","Measured as first-time funded wallets and median first balance","A funded wallet is the honest boundary between install and user"], "Fondear", "El primer saldo es el paso más difícil de cualquier funnel de wallets. Las cuatro horas sentadas son la ventana rara en la que alguien sí lo termina.", ["Punto de onboarding con staff durante el workshop de 17:00 a 21:00","Hay soporte presente en el paso donde se cae la gente","Se mide como wallets fondeadas por primera vez","Una wallet fondeada separa la instalación del uso real"], "注资", "首次入金是所有钱包漏斗中最难的一步。四小时的落座时段是少有的、真的会有人完成它的窗口。", ["17:00–21:00 工作坊期间设有人员值守的引导点","在最容易流失的环节提供现场支持","以首次注资钱包数与首次余额中位数计量","已注资钱包是安装量与真实用户的分界"]],
  ...
  var rewardFlow = [
    ...
    ["act", "First signed action", "During the seated workshop the guest completes the partner's defined action and signs for it.", ["17:00–21:00, seated, 100 attendees, staffed support","The window where a first-time user will actually finish","Signed from the guest's own key","Measured as qualified signed actions"], "Primera acción firmada", "Durante el workshop sentado el invitado completa la acción definida por el partner y la firma.", ["17:00–21:00, sentados, 100 asistentes, con soporte","La ventana donde un usuario nuevo sí termina","Firmada con la llave del propio invitado","Se mide como acciones firmadas calificadas"], "首次签名行动", "在落座工作坊期间，参与者完成合作方设定的行为并为其签名。", ["17:00–21:00，落座，100 人，有支持人员","新用户真正会完成动作的时间窗","由参与者自己的密钥签名","以合格的签名行为计量"]],
