(function () {
  ...
  /* @generated:concepts */
  var mechanics = [
    ["connect", "Connect", "There is no desk, no document scan and no wait for approval. A guest connects a wallet and is immediately able to do everything the night asks of them.", ["No email, no password and no identity check before the first action","Works for the guest who arrives at 21:00 with three minutes of patience","Measured as unique addresses connected, deduplicated, not app opens","The whole argument of the product, demonstrated in the first ten seconds"], "Conectar", "No hay módulo, ni escaneo de documento, ni espera de aprobación. El invitado conecta una wallet y de inmediato puede hacer todo lo que la noche le pide.", ["Sin correo, sin contraseña y sin verificación de identidad antes de la primera acción","Funciona para quien llega a las 21:00 con tres minutos de paciencia","Se mide como direcciones únicas conectadas, deduplicadas, no aperturas de app","Todo el argumento del producto, demostrado en los primeros diez segundos"], "连接", "没有引导台，没有证件扫描，也不用等待审核。来宾连接钱包，立刻就能完成这一夜要求的一切。", ["无需邮箱、密码或身份核查即可开始第一个动作","对 21:00 才到场、只有三分钟耐心的人同样成立","以去重后的唯一连接地址数计量，而非应用打开次数","产品的全部主张，在最初十秒内被演示完毕"]],
    ["deposit", "Deposit", "A guest funds the address they control, at Casa Luma, and the balance is theirs at every moment of the process. Nothing sits in the partner's custody waiting on a withdrawal request.", ["Transfer or on-ramp completed at the venue, not deferred to next week","The balance never leaves the guest's own keys at any point","Measured as addresses funded on the night and total value deposited","The funded address is what makes every later mechanic possible"], "Depositar", "El invitado fondea la dirección que él mismo controla, en Casa Luma, y el saldo es suyo en todo momento del proceso. Nada queda en custodia del socio esperando una solicitud de retiro.", ["Transferencia u on-ramp completado en el venue, no aplazado a la semana siguiente","El saldo nunca sale de las llaves del propio invitado","Se mide como direcciones fondeadas esa noche y valor total depositado","La dirección fondeada es lo que hace posible cada mecánica posterior"], "入金", "来宾在 Casa Luma 为自己掌控的地址注资，余额在整个过程的任何一刻都属于他本人。没有任何资金留在合作方托管中，等待一份提现申请。", ["在场地内完成转账或法币入金，不推迟到下一周","余额始终不离开来宾自己的私钥","以当晚完成注资的地址数与入金总额计量","已注资的地址，是后续每一个机制得以成立的前提"]],
  ...
  var rewardFlow = [
    ["connect", "Wallet connected in the workshop", "From 17:00 to 21:00 the seated Claude workshop for the music industry fills 100 chairs. A wallet connection takes seconds, so it sits inside the session instead of interrupting it.", ["17:00-21:00 · 100 seated attendees from the music industry","No signup desk is required, so nothing has to queue at the door","Measured as unique addresses connected before the 21:00 doors","The venue screen carries the session; connecting is a QR, not a form"], "Wallet conectada en el taller", "De 17:00 a 21:00 el taller de Claude para la industria musical llena 100 sillas. Conectar una wallet toma segundos, así que cabe dentro de la sesión en lugar de interrumpirla.", ["17:00-21:00 · 100 asistentes sentados de la industria musical","No hace falta módulo de registro, así que nada se forma en la puerta","Se mide como direcciones únicas conectadas antes de las 21:00","La pantalla del venue lleva la sesión; conectar es un QR, no un formulario"], "在工作坊中连接钱包", "17:00 至 21:00，面向音乐行业的 Claude 工作坊坐满 100 张椅子。连接钱包只需几秒，因此它嵌在课程之内，而不会打断课程。", ["17:00-21:00 · 100 位来自音乐行业的就座来宾","无需注册台，门口也就不会排队","以 21:00 开门前完成连接的唯一地址数计量","场地屏幕承载课程；连接只是一个二维码，不是一张表单"]],
    ["act", "Two swaps completed on site", "At 21:00 the doors open to 120 further guests. The mission is two swaps, both settled onchain inside the venue.", ["21:00 doors · 120 further guests on top of the workshop audience","First swap guided by staff, second completed by the guest alone","Measured as addresses reaching two settled swaps on event grounds","Deposit, liquidity and limit orders sit above this as optional depth"], "Dos swaps completados en sitio", "A las 21:00 abren las puertas para 120 invitados más. La misión son dos swaps, ambos liquidados onchain dentro del venue.", ["21:00 · llegan 120 invitados además del público del taller","El primer swap lo acompaña el equipo; el segundo lo hace el invitado solo","Se mide como direcciones que llegan a dos swaps liquidados en el evento","Depósito, liquidez y órdenes límite quedan encima como profundidad opcional"], "在场内完成两次兑换", "21:00 开门，另有 120 位来宾到场。任务是两次兑换，都在场地内于链上结算完成。", ["21:00 开门 · 在工作坊人群之外再来 120 位来宾","第一次由工作人员陪同，第二次由来宾独立完成","以在活动现场完成两笔链上结算兑换的地址数计量","入金、流动性与限价单作为可选的进阶层级叠加其上"]],
