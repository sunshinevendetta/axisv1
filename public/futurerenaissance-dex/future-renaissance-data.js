(function () {
  ...
  window.FUTURE_RENAISSANCE = deepFreeze({
    ...
    productFocus: {
      ...
      name: "DEX",
      slot: "[DEX BRAND]",
      discipline: "Onchain swaps and liquidity with no account required",
      mechanics: [
        { id: "connect", name: "Connect", role: "Wallet connected, nothing signed up for" },
        { id: "deposit", name: "Deposit", role: "Funds moved into the DEX at the venue" },
        { id: "swap", name: "Two Swaps", role: "Two completed swaps on event grounds" },
        { id: "liquidity", name: "Liquidity", role: "A pool position opened for the night" },
        { id: "limit", name: "Limit Order", role: "An order working while the DJ plays" },
        { id: "claim", name: "Claim", role: "Rewards claimed onchain at close" },
        { id: "prove", name: "Prove", role: "Every action has a hash anyone can check" },
      ],
      flow: [
        { id: "connect", stage: "Connect", context: "Workshop", action: "Wallet connected in the workshop" },
        { id: "act", stage: "Act", context: "Doors", action: "Two swaps completed on site" },
        { id: "validate", stage: "Validate", context: "After party", action: "Onchain state read by staff" },
        { id: "redeem", stage: "Redeem", context: "Bar", action: "Drink released against the tx" },
        { id: "screen", stage: "Screen", context: "LED wall", action: "Transaction hash drives the wall" },
        { id: "report", stage: "Report", context: "Post-event", action: "Report delivered as tx hashes" },
      ],
    },
  });
