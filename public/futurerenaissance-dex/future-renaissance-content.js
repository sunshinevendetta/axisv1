(function () {
  ...
  var slides = [
    ...
    /* @generated:slides */
    '<section class="fr-slide frx-brand-function" data-slide-id="brand-function" data-scene="structured" data-label="DEX function">' +
      frameTop("08", "brandFunction", "DEX FUNCTION") +
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="brandFunction.kicker">DEX FUNCTION</span><h2 data-reveal data-i18n="brandFunction.title">NO ACCOUNT. NO KYC. SEVEN ONCHAIN ACTIONS IN ONE ROOM.</h2><p data-reveal data-i18n="brandFunction.copy">A DEX partner does not need an onboarding desk, because there is nothing to sign up for. A wallet connects in seconds, and every action that follows is executed by the guest, held by the guest, and readable by anyone on a public explorer.</p></div>' +
      '<div class="frx-function-grid" data-crystallize>' + focus.mechanics.map(mechanicCard).join("") + '</div>' +
      '<div class="frx-brand-rule" data-reveal><span data-i18n="brandFunction.noLogoWall">NOT A LOGO LOOPING BEHIND THE DJ BOOTH.</span><strong data-i18n="brandFunction.distinctFunctions">SEVEN ONCHAIN ACTIONS, EACH ONE VERIFIABLE BY ANYONE.</strong></div>' +
    '</section>',
    ...
    '<section class="fr-slide frx-cross-week" data-slide-id="reward-flow" data-scene="structured" data-label="The reward flow">' +
      ...
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="crossWeek.kicker">THE REWARD FLOW</span><h2 data-reveal data-i18n="crossWeek.title">A SWAP BUYS THE DRINK. THE CHAIN KEEPS THE RECEIPT.</h2><p data-reveal data-i18n="crossWeek.copy">Wallet connect, two settled swaps, staff validation read off the chain, drink redemption at the bar, the transaction hash driving the LED wall, then a report made of hashes. Nothing in that chain has to be taken on trust.</p></div>' +
