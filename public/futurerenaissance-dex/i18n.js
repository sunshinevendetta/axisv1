(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      /* @generated:es */
      "mechanics.connect.name": "CONECTAR",
      "mechanics.connect.role": "Wallet conectada, sin registrarse a nada",
      "mechanics.deposit.name": "DEPOSITAR",
      "mechanics.deposit.role": "Fondos movidos al DEX en el venue",
      "mechanics.swap.name": "DOS SWAPS",
      "mechanics.swap.role": "Dos swaps completados en el evento",
      "mechanics.liquidity.name": "LIQUIDEZ",
      "mechanics.liquidity.role": "Una posición en pool abierta esa noche",
      "mechanics.limit.name": "ORDEN LÍMITE",
      "mechanics.limit.role": "Una orden que trabaja mientras suena el DJ",
      "mechanics.claim.name": "RECLAMAR",
      "mechanics.claim.role": "Recompensas reclamadas onchain al cierre",
      "mechanics.prove.name": "COMPROBAR",
      "mechanics.prove.role": "Cada acción tiene un hash verificable",
      "step.connect.stage": "Conexión",
      "step.connect.action": "WALLET CONECTADA EN EL TALLER",
      "step.act.stage": "Acción",
      "step.act.action": "DOS SWAPS COMPLETADOS EN SITIO",
      "step.validate.stage": "Validación",
      "step.validate.action": "ESTADO ONCHAIN LEÍDO POR EL STAFF",
      "step.redeem.stage": "Canje",
      "step.redeem.action": "BEBIDA LIBERADA CONTRA LA TX",
      "step.screen.stage": "Pantalla",
      "step.screen.action": "EL HASH DIBUJA EL MURO LED",
      "step.report.stage": "Reporte",
      "step.report.action": "REPORTE ENTREGADO EN HASHES",
      "nav.brandFunction": "FUNCIÓN DEL DEX",
      "brandFunction.kicker": "FUNCIÓN DEL DEX",
      "brandFunction.title": "SIN CUENTA. SIN KYC. SIETE ACCIONES ONCHAIN EN UNA SALA.",
      "brandFunction.copy": "Un socio DEX no necesita módulo de registro, porque no hay nada a qué registrarse. Se conecta una wallet en segundos y todo lo que sigue lo ejecuta el invitado, lo custodia el invitado y lo puede leer cualquiera en un explorador público.",
      "brandFunction.noLogoWall": "NO ES UN LOGO EN LOOP DETRÁS DE LA CABINA.",
      "brandFunction.distinctFunctions": "SIETE ACCIONES ONCHAIN, CADA UNA VERIFICABLE POR CUALQUIERA.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "UN SWAP PAGA LA BEBIDA. LA CADENA GUARDA EL RECIBO.",
      "crossWeek.copy": "Conexión de wallet, dos swaps liquidados, validación de staff leída de la cadena, canje de bebida en la barra, el hash de la transacción dibujando el muro LED y después un reporte hecho de hashes. Ningún paso de ese flujo hay que creerlo de buena fe.",
      "crossWeek.note": "FLUJO DE EJEMPLO · LAS ACCIONES EXACTAS SE DISEÑAN SEGÚN EL PROTOCOLO.",
    /* @end */
    },
    zh: {
      "nav.proposition": "提案",
      ...
      /* @generated:zh */
      "mechanics.connect.name": "连接",
      "mechanics.connect.role": "连接钱包，无需注册任何账户",
      "mechanics.deposit.name": "入金",
      "mechanics.deposit.role": "在现场把资金转入 DEX",
      "mechanics.swap.name": "两次兑换",
      "mechanics.swap.role": "在活动场内完成两次兑换",
      "mechanics.liquidity.name": "流动性",
      "mechanics.liquidity.role": "当晚开设的一个池中仓位",
      "mechanics.limit.name": "限价单",
      "mechanics.limit.role": "DJ 播放时仍在工作的挂单",
      "mechanics.claim.name": "领取",
      "mechanics.claim.role": "散场时在链上领取奖励",
      "mechanics.prove.name": "可证",
      "mechanics.prove.role": "每个动作都有可核验的哈希",
      "step.connect.stage": "连接",
      "step.connect.action": "在工作坊中连接钱包",
      "step.act.stage": "行动",
      "step.act.action": "在场内完成两次兑换",
      "step.validate.stage": "核验",
      "step.validate.action": "工作人员读取链上状态",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "凭交易释放酒水",
      "step.screen.stage": "上屏",
      "step.screen.action": "哈希驱动 LED 墙",
      "step.report.stage": "报告",
      "step.report.action": "以交易哈希交付报告",
      "nav.brandFunction": "DEX 的职能",
      "brandFunction.kicker": "DEX 的职能",
      "brandFunction.title": "无账户。无 KYC。一个房间里的七个链上动作。",
      "brandFunction.copy": "DEX 合作方不需要注册台，因为根本没有什么可注册的。钱包在几秒内连接完成，之后的每一个动作都由来宾自己执行、自己保管，并且任何人都能在公共区块浏览器上读到。",
      "brandFunction.noLogoWall": "不是 DJ 台后循环播放的一个标志。",
      "brandFunction.distinctFunctions": "七个链上动作，每一个都能被任何人核验。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "一次兑换换来一杯酒，链上留着收据。",
      "crossWeek.copy": "连接钱包、两笔已结算的兑换、工作人员依据链上状态核验、在吧台兑换酒水、交易哈希驱动 LED 墙，随后是一份由哈希构成的报告。这条链路上没有任何一环需要凭信任接受。",
      "crossWeek.note": "示例流程 · 具体动作将围绕该协议设计。",
    /* @end */
    }
  };
