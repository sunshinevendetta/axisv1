(function () {
  ...
  var mechanics = [
    ...
    ["bardrop", "Bar Drop", "One drop opens on the clock when the after-party doors open and 120 further guests arrive. Collecting inside that window is the action that releases the drink at the bar.", ["The window is announced from the wall and by staff working the door","Collect inside the window, redeem at the bar, no separate voucher","Measured as collects inside the window against arrivals in those minutes","Gives the second wave of the night a reason to open the app on arrival"], "Drop de Barra", "Un drop abre en punto cuando se abren las puertas del after y llegan 120 invitados más. Coleccionar dentro de esa ventana es la acción que libera el trago en la barra.", ["La ventana se anuncia desde el muro y por el staff en la puerta","Coleccionas dentro de la ventana y canjeas en barra, sin vale aparte","Se mide como colecciones dentro de la ventana contra llegadas del momento","Le da a la segunda oleada una razón para abrir la app al entrar"], "整点发售", "当 21:00 后半场开门、另有 120 位来宾进场时，一场限时发售准时开启。在该窗口内完成收藏，就是换取吧台饮品的那个动作。", ["发售窗口由主屏和门口工作人员同时告知","窗口内收藏，吧台直接兑换，不需要另发券","以窗口内的收藏数、对照同一时段的进场人数衡量","让当晚第二波人群一进门就有理由打开这个应用"]],
    ...
    ["nightshelf", "Night Shelf", "Everything a guest collected across the night resolves into one set held at their own address. Months later it is still the record that they were in the room on October 29.", ["Workshop piece, guest edition and drop collect resolve to one shelf","Held in the guest's own custody, not as a platform balance","Measured as guests still holding at least one piece thirty days later","The marketplace keeps a reachable collector, not an attendance list"], "Colección de la Noche", "Todo lo que un invitado coleccionó durante la noche se resuelve en un solo conjunto bajo su propia dirección. Meses después sigue siendo la prueba de que estuvo ahí el 29 de octubre.", ["Pieza del taller, edición del público y drop quedan en un mismo conjunto","Bajo custodia del propio invitado, no como saldo de plataforma","Se mide como invitados que conservan al menos una pieza a 30 días","El marketplace se queda con un coleccionista alcanzable, no con una lista"], "当晚收藏", "来宾整晚收藏的一切，最终汇成他自己地址下的一组作品。数月之后，它依然是此人 10 月 29 日在场的凭证。", ["工作坊作品、观众版次与限时发售收藏，归入同一组","由来宾自己保管，而不是留在平台账户余额里","以 30 天后仍持有至少一件作品的来宾数量衡量","平台留下的是可触达的收藏者，而不是一份到场名单"]],
  ];
  ...
  var rewardFlow = [
    ["onboard", "Seat scan opens the market", "Doors at 17:00, 100 chairs, one scan per seat. The marketplace account is created while a host is standing in the row, not alone on a phone at home.", ["Every one of the 100 seats is scanned on the way in","Account and first listing view happen with staff in the aisle","Measured as accounts opened at the seat, not as app installs","A failure at this step is visible immediately and fixed on the spot"], "El escaneo del asiento abre el marketplace", "Puertas a las 17:00, 100 sillas, un escaneo por asiento. La cuenta del marketplace se crea con un anfitrión parado en la fila, no a solas con el celular en casa.", ["Los 100 asientos se escanean al entrar","La cuenta y la primera vista de listados ocurren con staff en el pasillo","Se mide como cuentas abiertas en el asiento, no como instalaciones","Un fallo aquí se ve al momento y se resuelve ahí mismo"], "扫码入座即开通账户", "17:00 开门，100 把椅子，每个座位扫一次码。平台账户是在主持人就站在这一排时开通的，而不是回家一个人对着手机完成。", ["100 个座位在入场时全部完成扫码","开户与第一次浏览在售作品，都有工作人员在过道协助","以在座位上开通的账户数衡量，而不是应用安装量","这一步出问题当场就能看见，也当场解决"]],
    ["act", "First collect from the seat", "The Claude workshop is hands-on, so the first collect is part of the session itself. Every attendee leaves the 17:00 to 21:00 block having used the product once.", ["The session runs on the venue screen, so the step is done together","Producers, artists, labels, managers and studios all complete it","Measured as first collects completed inside the workshop block","Nobody is asked to go and try the product later at home"], "Primera colección desde el asiento", "El taller de Claude es práctico, así que la primera colección es parte de la sesión. Cada asistente sale del bloque de 17:00 a 21:00 habiendo usado el producto una vez.", ["La sesión corre en la pantalla del venue y el paso se hace en conjunto","Productores, artistas, sellos, managers y estudios lo completan","Se mide como primeras colecciones completadas dentro del taller","A nadie se le pide probar el producto después, en su casa"], "在座位上完成首次收藏", "Claude 工作坊是动手环节，因此首次收藏就是课程的一部分。每位参与者离开 17:00 至 21:00 这一段时，都已经完整用过一次产品。", ["课程内容同步在场馆主屏上，这一步全场一起做","制作人、艺术家、厂牌、经纪人和录音棚都会完成","以工作坊时段内完成的首次收藏数量衡量","不需要任何人事后回家再自己试一次"]],
    ["validate", "Staff validates at 21:00", "At 21:00 the after-party doors open to 120 further guests. Staff check the collect on the guest's own screen before anything is released.", ["Staff validation and the onchain record have to agree","Workshop guests who stayed are recognised without repeating the flow","Measured as validated actions, kept separate from headcount","This is the number the report is built on, not attendance"], "El staff valida a las 21:00", "A las 21:00 abren las puertas del after para 120 invitados más. El staff revisa la colección en la pantalla del propio invitado antes de liberar nada.", ["La validación del staff y el registro onchain tienen que coincidir","Quien se quedó del taller es reconocido sin repetir el flujo","Se mide como acciones validadas, aparte del conteo de asistentes","Sobre este número se construye el reporte, no sobre la asistencia"], "21:00 由工作人员核验", "21:00 后半场开门，另有 120 位来宾进场。工作人员在来宾自己的屏幕上核对收藏记录，之后才会放行任何奖励。", ["人工核验与链上记录必须一致","从工作坊留下来的来宾无需重走一遍流程","以核验通过的行动数衡量，与到场人数分开统计","报告建立在这个数字上，而不是到场人数"]],
