(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      /* @generated:es */
      "mechanics.livemint.name": "MINTEO EN VIVO",
      "mechanics.livemint.role": "Piezas minteadas mientras suena el set",
      "mechanics.hashdraw.name": "DIBUJO POR HASH",
      "mechanics.hashdraw.role": "Coleccionar es lo que dibuja la obra",
      "mechanics.gallery.name": "ESCENA GALERÍA",
      "mechanics.gallery.role": "La interfaz del marketplace en el muro",
      "mechanics.guestedition.name": "EDICIÓN DEL PÚBLICO",
      "mechanics.guestedition.role": "Lo que hizo el público, listado como edición",
      "mechanics.bardrop.name": "DROP DE BARRA",
      "mechanics.bardrop.role": "Un drop en punto al abrir a las 21:00",
      "mechanics.royalty.name": "REGALÍAS EN VIVO",
      "mechanics.royalty.role": "El pago al artista, visible al liquidarse",
      "mechanics.nightshelf.name": "COLECCIÓN DE LA NOCHE",
      "mechanics.nightshelf.role": "La colección es la prueba de haber estado",
      "step.onboard.stage": "Alta",
      "step.onboard.action": "EL ESCANEO DEL ASIENTO ABRE EL MARKETPLACE",
      "step.act.stage": "Acción",
      "step.act.action": "PRIMERA COLECCIÓN DESDE EL ASIENTO",
      "step.validate.stage": "Validación",
      "step.validate.action": "EL STAFF VALIDA A LAS 21:00",
      "step.redeem.stage": "Canje",
      "step.redeem.action": "UNA COLECCIÓN VERIFICADA PAGA EL TRAGO",
      "step.screen.stage": "Muro",
      "step.screen.action": "LA PIEZA SUBE AL MURO",
      "step.report.stage": "Reporte",
      "step.report.action": "LA NOCHE SE RESUELVE EN UN REGISTRO",
      "nav.brandFunction": "FUNCIÓN DEL MARKETPLACE",
      "brandFunction.kicker": "FUNCIÓN DEL MARKETPLACE",
      "brandFunction.title": "LA SALA GENERA EL INVENTARIO. EL MARKETPLACE LO OPERA.",
      "brandFunction.copy": "Es una noche que produce su propia oferta: obras de Verse que se dibujan a partir de un hash en el momento en que se coleccionan, lanzamientos de Pixelord que publican sonido y 3D juntos, y el material del muro LED que generó el propio público con Claude. Un socio marketplace no necesita simular escasez aquí, opera el mercado de obra que no existía antes de las 17:00.",
      "brandFunction.noLogoWall": "NO ES UN LOGO DETRÁS DE LA CABINA DEL DJ.",
      "brandFunction.distinctFunctions": "SIETE FUNCIONES DE MERCADO, CADA UNA CON OBRA LISTADA Y COLECCIONISTAS CONTADOS.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "COLECCIONA EN LA APP. CANJEA EN LA BARRA. APARECE EN EL REPORTE.",
      "crossWeek.copy": "Un giveaway termina en el momento en que se entrega el premio. Aquí la colección es guiada por staff, validada por una persona, canjeada por un trago en la barra, mostrada en el muro LED y contada en el reporte posterior.",
      "crossWeek.note": "FLUJO DE EJEMPLO · LAS ACCIONES EXACTAS SE DISEÑAN SEGÚN EL PRODUCTO.",
    /* @end */
    },
    zh: {
      "nav.proposition": "提案",
      ...
      /* @generated:zh */
      "mechanics.livemint.name": "现场铸造",
      "mechanics.livemint.role": "演出进行中即完成铸造",
      "mechanics.hashdraw.name": "哈希生成",
      "mechanics.hashdraw.role": "收藏这个动作本身就是创作",
      "mechanics.gallery.name": "画廊场景",
      "mechanics.gallery.role": "平台界面直接成为主屏画面",
      "mechanics.guestedition.name": "观众版次",
      "mechanics.guestedition.role": "观众生成的画面上架为版次",
      "mechanics.bardrop.name": "整点发售",
      "mechanics.bardrop.role": "21:00 开门时准点开启的发售",
      "mechanics.royalty.name": "版税可见",
      "mechanics.royalty.role": "艺术家分成结算时当场显示",
      "mechanics.nightshelf.name": "当晚收藏",
      "mechanics.nightshelf.role": "这组收藏就是到场的凭证",
      "step.onboard.stage": "开通",
      "step.onboard.action": "扫码入座即开通账户",
      "step.act.stage": "行动",
      "step.act.action": "在座位上完成首次收藏",
      "step.validate.stage": "核验",
      "step.validate.action": "21:00 由工作人员核验",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "核验通过即可换一杯",
      "step.screen.stage": "上屏",
      "step.screen.action": "作品登上主屏",
      "step.report.stage": "报告",
      "step.report.action": "整晚收敛成一份账目",
      "nav.brandFunction": "平台功能",
      "brandFunction.kicker": "平台功能",
      "brandFunction.title": "内容由现场产生，市场由平台运营。",
      "brandFunction.copy": "这是一个自己生产供给的夜晚：Verse 的作品在被收藏的那一刻依据哈希把自己画出来，Pixelord 的发布把声音与 3D 一起上链，而 LED 主屏上的画面由来宾用 Claude 亲手生成。交易平台在这里不必制造稀缺，它经营的是 17:00 之前根本不存在的作品。",
      "brandFunction.noLogoWall": "不是 DJ 台背后的一个标志。",
      "brandFunction.distinctFunctions": "七项市场功能，每一项都有上架的作品和可计数的收藏者。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "在应用里收藏，在吧台兑换，在报告里留痕。",
      "crossWeek.copy": "普通抽奖在奖品递出的那一刻就结束了。在这里，收藏由工作人员引导、由人工核验、在吧台兑换成一杯饮品、出现在 LED 主屏上，并被计入活动后的报告。",
      "crossWeek.note": "示例流程 · 具体行动将围绕该产品设计。",
    /* @end */
    }
  };
