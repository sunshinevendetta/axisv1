(function () {
  ...
  window.FUTURE_RENAISSANCE = deepFreeze({
    ...
    productFocus: {
      id: "marketplace",
      name: "Marketplace",
      slot: "[MARKETPLACE BRAND]",
      discipline: "Primary and secondary market for digital art",
      mechanics: [
        { id: "livemint", name: "Live Mint", role: "Work minted while the set is playing" },
        { id: "hashdraw", name: "Hash Draw", role: "The collect is what draws the work" },
        { id: "gallery", name: "Gallery Scene", role: "The marketplace UI becomes a wall scene" },
        { id: "guestedition", name: "Guest Edition", role: "Guest wall output listed as an edition" },
        { id: "bardrop", name: "Bar Drop", role: "A timed drop at the 22:00 doors" },
        { id: "royalty", name: "Royalty Ticker", role: "Artist payouts shown as they settle" },
        { id: "nightshelf", name: "Night Shelf", role: "The collection is the proof of being there" },
      ],
      flow: [
        { id: "onboard", stage: "Onboard", context: "Workshop", action: "Seat scan opens the market" },
        { id: "act", stage: "Act", context: "Workshop", action: "First collect from the seat" },
        { id: "validate", stage: "Validate", context: "Doors", action: "Staff validates at 22:00" },
        { id: "redeem", stage: "Redeem", context: "Bar", action: "A verified collect pours a drink" },
        { id: "screen", stage: "Screen", context: "LED wall", action: "The piece goes on the wall" },
        { id: "report", stage: "Report", context: "Post-event", action: "The night resolves to a ledger" },
      ],
    },
  });
