(function () {
  ...
  window.FUTURE_RENAISSANCE = Object.freeze({
    ...
    venue: "Diablito Secret Club",
    venueSlug: "diablito",
    city: "Mexico City",
    slug: "/futurerenaissance-diablito",
    attendees: 250,
  ...
  window.FUTURE_RENAISSANCE_ARTISTS = Object.freeze({
    "verse-works": Object.freeze({
      ...
      facts: [
        ...
        ["AT DIABLITO SECRET CLUB", "Generative works on the venue screens"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN DIABLITO SECRET CLUB", "Obra generativa en las pantallas"],
        ],
      },
      zh: {
        kind: "平台",
        ...
        facts: [
          ...
          ["创立", "2022 · 伦敦"],
          ["形式", "长格式生成艺术，由哈希值生成"],
          ["在 DIABLITO SECRET CLUB", "生成作品在场地屏幕上运行"],
        ],
      },
    }),
    pixelord: Object.freeze({
      name: "Pixelord",
      monogram: "PX",
      monogramMedia: Object.freeze({ type: "image", src: "/futurerenaissance-diablito/pixelord.jpg", alt: "Pixelord" }),
      kind: "ARTIST",
      tag: "ARTIST",
      ...
      facts: [
        ...
        ["AT DIABLITO SECRET CLUB", "Digital work in the line up"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN DIABLITO SECRET CLUB", "Obra digital en el line up"],
        ],
      },
      zh: {
        kind: "艺术家",
        ...
        facts: [
          ...
          ["在 DIABLITO SECRET CLUB", "Future Renaissance 阵容中的数字作品"],
        ],
      },
    }),
