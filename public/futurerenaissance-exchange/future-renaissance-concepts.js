(function () {
  ...
  var mechanics = [
    ...
    ["invite", "Invite", "Referral works at Casa Luma because the person being invited is standing two metres away and can finish the flow before the drink is poured.", ["A guest sends a referral to someone physically in the venue","The invited guest can verify at the same desk within minutes","Measured as referrals sent and referrals completed the same night","Both sides of the referral are validated by staff, not self-reported"], "Invitar", "El referido funciona en Casa Luma porque la persona invitada está a dos metros y puede terminar el flujo antes de que sirvan la bebida.", ["El invitado manda un referido a alguien que está físicamente en el venue","El referido puede verificarse en el mismo módulo en cuestión de minutos","Se mide como referidos enviados y referidos completados esa misma noche","Los dos lados del referido los valida el personal, no se autodeclaran"], "邀请", "邀请机制在 Casa Luma 之所以成立，是因为被邀请的人就站在两米之外，可以在酒倒好之前把流程走完。", ["来宾把邀请发给此刻就在场地内的人","被邀请者可以在同一个引导台几分钟内完成验证","以发出的邀请数与当晚完成的邀请数计量","邀请双方都由工作人员核验，而非自行申报"]],
    ...
    ["retain", "Retain", "Unlike a giveaway, a verified account persists. It is a real, reachable, funded relationship the partner still holds weeks after Casa Luma empties.", ["The account survives the night without asking the guest to register again","Post-event contact runs through the product, not a scraped guest list","Measured as accounts still funded and still trading 30 days later","The asset the partner keeps once the production is over"], "Retener", "A diferencia de una dinámica de regalos, una cuenta verificada permanece: es una relación real, alcanzable y fondeada que el socio conserva semanas después de que Casa Luma se vacía.", ["La cuenta sobrevive a la noche sin pedirle al invitado que se registre otra vez","El contacto posterior corre por el producto, no por una lista de invitados","Se mide como cuentas aún fondeadas y operando 30 días después","Es el activo que el socio conserva cuando termina la producción"], "留存", "与送赠品不同，已验证账户会留下来：这是一段真实、可触达、已入金的关系，在 Casa Luma 散场数周之后依然属于合作方。", ["账户跨过当晚继续存在，无需来宾重新注册","后续联系通过产品本身进行，而不是一份导出的宾客名单","以 30 天后仍有资金、仍在交易的账户数计量","制作结束后合作方真正保留下来的资产"]],
  ];
  ...
  var rewardFlow = [
    ["onboard", "Verify at the onboarding desk", "From 17:00 to 21:00 the seated Claude workshop for the music industry holds 100 people, a chair for every attendee. It is the calmest verification window of the night, because nobody is standing in a queue.", ["17:00-21:00 · Claude workshop for the music industry, 100 seats","Everyone is seated, so onboarding is accompanied rather than queued","Measured as verifications completed before the 21:00 doors","With staff present a failed scan gets fixed instead of abandoned"], "Verificación en el módulo de onboarding", "De 17:00 a 21:00 el taller de Claude para la industria musical ocupa la sala sentada, con 100 lugares y una silla para cada quien. Es la ventana más tranquila de la noche para verificar, porque nadie está formado.", ["17:00-21:00 · taller de Claude para la industria musical, 100 lugares","Todos sentados: el onboarding es acompañado, no una fila","Se mide como verificaciones completadas antes de las 21:00","Con personal presente, un escaneo fallido se arregla en vez de abandonarse"], "在引导台完成验证", "17:00 至 21:00，面向音乐行业的 Claude 工作坊占据整个坐席空间，100 个座位，人人有椅子。这是全场最从容的验证时段，因为没有人在排队。", ["17:00-21:00 · 面向音乐行业的 Claude 工作坊，100 个座位","全员就座，引导是陪同式的，而不是排队","以 21:00 开门前完成的验证数计量","有人在场，扫描失败会被修好，而不是被放弃"]],
    ["act", "First order placed in the app", "At 21:00 the doors open to 120 further guests on top of the workshop room that stays. The mission is one completable thing, not a form.", ["21:00 doors · 120 further guests on top of the workshop audience","One action, finishable in under two minutes on a phone","Measured as qualified actions, kept separate from attendance","The exact action is chosen with the partner before the night"], "Primera orden dentro de la app", "A las 21:00 abren las puertas para 120 invitados más, encima de la sala del taller que se queda. La misión es una sola cosa que se puede terminar, no un formulario.", ["21:00 · llegan 120 invitados además del público del taller","Una sola acción, terminable en menos de dos minutos desde el teléfono","Se mide como acciones calificadas, separadas de la simple asistencia","La acción exacta se define con el socio antes de la noche"], "在应用内完成首笔下单", "21:00 开门，在留下来的工作坊人群之外，另有 120 位来宾到场。任务是一件能够被完成的具体事，而不是一张表单。", ["21:00 开门 · 在工作坊人群之外再来 120 位来宾","一个动作，在手机上两分钟内即可完成","以合格行为数计量，与单纯到场区分开","具体动作在活动前与合作方共同确定"]],
