(function () {
  ...
  var slides = [
    ...
    /* @generated:slides */
    '<section class="fr-slide frx-brand-function" data-slide-id="brand-function" data-scene="structured" data-label="Exchange function">' +
      frameTop("08", "brandFunction", "EXCHANGE FUNCTION") +
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="brandFunction.kicker">EXCHANGE FUNCTION</span><h2 data-reveal data-i18n="brandFunction.title">ONE NIGHT. SEVEN EXCHANGE ACTIONS COMPLETED IN THE ROOM.</h2><p data-reveal data-i18n="brandFunction.copy">An exchange partner does not buy a logo on the bar menu. For one night at Bar Oriente the product is where identity gets verified, where the first account gets funded, where the first order gets placed, and what releases the drink.</p></div>' +
      '<div class="frx-function-grid" data-crystallize>' + focus.mechanics.map(mechanicCard).join("") + '</div>' +
      '<div class="frx-brand-rule" data-reveal><span data-i18n="brandFunction.noLogoWall">NOT A LOGO ON THE BAR MENU.</span><strong data-i18n="brandFunction.distinctFunctions">SEVEN APP ACTIONS, EACH WITH ITS OWN VERIFIED COUNT.</strong></div>' +
    '</section>',
    ...
    '<section class="fr-slide frx-cross-week" data-slide-id="reward-flow" data-scene="structured" data-label="The reward flow">' +
      ...
      '<div class="frx-heading"><span class="eyebrow" data-reveal data-i18n="crossWeek.kicker">THE REWARD FLOW</span><h2 data-reveal data-i18n="crossWeek.title">A VERIFIED ACTION BUYS THE DRINK. THE DRINK LEAVES A RECORD.</h2><p data-reveal data-i18n="crossWeek.copy">Staff-guided onboarding, an action completed inside your app, staff validation, drink redemption at the bar, your live state on the LED wall, then a report. A giveaway ends when the prize is handed over; this ends in a document.</p></div>' +
