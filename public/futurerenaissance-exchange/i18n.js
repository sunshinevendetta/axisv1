(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      /* @generated:es */
      "mechanics.verify.name": "VERIFICAR",
      "mechanics.verify.role": "KYC completado en el módulo de onboarding",
      "mechanics.deposit.name": "DEPOSITAR",
      "mechanics.deposit.role": "Primer saldo fondeado antes del DJ",
      "mechanics.trade.name": "PRIMERA OPERACIÓN",
      "mechanics.trade.role": "El primer convert o spot, en la sala",
      "mechanics.outcomes.name": "OUTCOMES",
      "mechanics.outcomes.role": "Una posición en vivo tomada esa noche",
      "mechanics.invite.name": "INVITAR",
      "mechanics.invite.role": "El referido enviado a alguien en la sala",
      "mechanics.withdraw.name": "RETIRAR",
      "mechanics.withdraw.role": "Prueba de que el dinero sale cuando se pide",
      "mechanics.retain.name": "RETENER",
      "mechanics.retain.role": "Una cuenta verificada abierta en noviembre",
      "step.onboard.stage": "Onboarding",
      "step.onboard.action": "VERIFICACIÓN EN EL MÓDULO",
      "step.act.stage": "Acción",
      "step.act.action": "PRIMERA ORDEN EN LA APP",
      "step.validate.stage": "Validación",
      "step.validate.action": "VALIDACIÓN DE STAFF EN PISO",
      "step.redeem.stage": "Canje",
      "step.redeem.action": "CANJE DE BEBIDA EN LA BARRA",
      "step.screen.stage": "Pantalla",
      "step.screen.action": "ESTADO EN EL MURO LED",
      "step.report.stage": "Reporte",
      "step.report.action": "REPORTE DESPUÉS DE LA NOCHE",
      "nav.brandFunction": "FUNCIÓN DEL EXCHANGE",
      "brandFunction.kicker": "FUNCIÓN DEL EXCHANGE",
      "brandFunction.title": "UNA NOCHE. SIETE ACCIONES DE EXCHANGE COMPLETADAS EN LA SALA.",
      "brandFunction.copy": "Un socio exchange no compra un logo en la carta de la barra. Durante una sola noche en Casa Luma el producto es donde se verifica la identidad, donde se fondea la primera cuenta, donde se coloca la primera orden y lo que libera la bebida.",
      "brandFunction.noLogoWall": "NO ES UN LOGO EN LA CARTA DE LA BARRA.",
      "brandFunction.distinctFunctions": "SIETE ACCIONES EN LA APP, CADA UNA CON SU PROPIO CONTEO VERIFICADO.",
      "crossWeek.kicker": "EL FLUJO DE RECOMPENSA",
      "crossWeek.title": "UNA ACCIÓN VERIFICADA PAGA LA BEBIDA. LA BEBIDA DEJA REGISTRO.",
      "crossWeek.copy": "Onboarding guiado por staff, una acción completada dentro de tu app, validación de staff, canje de bebida en la barra, tu estado en vivo en el muro LED y después un reporte. Una dinámica de regalos termina cuando se entrega el premio; esto termina en un documento.",
    ...
    zh: {
      ...
      /* @generated:zh */
      "mechanics.verify.name": "验证",
      "mechanics.verify.role": "在引导台完成 KYC",
      "mechanics.deposit.name": "入金",
      "mechanics.deposit.role": "开场 DJ 之前完成首次入金",
      "mechanics.trade.name": "首次交易",
      "mechanics.trade.role": "在现场完成第一笔兑换或现货订单",
      "mechanics.outcomes.name": "预测市场",
      "mechanics.outcomes.role": "当晚建立的一个真实仓位",
      "mechanics.invite.name": "邀请",
      "mechanics.invite.role": "把邀请发给同一个房间里的人",
      "mechanics.withdraw.name": "提现",
      "mechanics.withdraw.role": "证明资金随时都能取出",
      "mechanics.retain.name": "留存",
      "mechanics.retain.role": "十一月仍然存在的已验证账户",
      "step.onboard.stage": "引导",
      "step.onboard.action": "在引导台完成验证",
      "step.act.stage": "行动",
      "step.act.action": "在应用内完成首笔下单",
      "step.validate.stage": "核验",
      "step.validate.action": "工作人员现场核验",
      "step.redeem.stage": "兑换",
      "step.redeem.action": "在吧台兑换酒水",
      "step.screen.stage": "上屏",
      "step.screen.action": "状态出现在 LED 墙上",
      "step.report.stage": "报告",
      "step.report.action": "活动结束后交付报告",
      "nav.brandFunction": "交易所的职能",
      "brandFunction.kicker": "交易所的职能",
      "brandFunction.title": "一个夜晚。七个在现场完成的交易所动作。",
      "brandFunction.copy": "交易所合作方买到的不是酒水单上的一个标志。在 Casa Luma 的这一夜里，产品是身份被验证的地方、第一个账户被注资的地方、第一笔订单被下达的地方，也是释放那杯酒的东西。",
      "brandFunction.noLogoWall": "不是酒水单上的一个标志。",
      "brandFunction.distinctFunctions": "七个应用内动作，每一个都有各自可核验的计数。",
      "crossWeek.kicker": "奖励流程",
      "crossWeek.title": "一次已验证的行为换来一杯酒，这杯酒留下记录。",
      "crossWeek.copy": "工作人员引导的入场引导、在你的应用内完成的一个动作、工作人员核验、吧台兑换酒水、LED 墙上的实时状态，随后是一份报告。送赠品在礼物递出的那一刻就结束了；这套流程最后交付的是一份文件。",
      "crossWeek.note": "示例流程 · 具体动作将围绕该产品设计。",
    /* @end */
    }
  };
