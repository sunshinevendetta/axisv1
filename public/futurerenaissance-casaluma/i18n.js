(function () {
  ...
  var TEXT = {
    ...
    es: {
      ...
      "claude.host": "SEDE ANFITRIONA: CASA LUMA",
      ...
      "workshop.phaseNightNote": "La pista abre a las 21:00 para 120 invitados más, además de los asistentes que se quedan.",
      ...
      "workshop.copy": "Cuatro horas sentados, hechas para quienes trabajan en música. Productores, artistas, sellos, managers y estudios trabajan de forma práctica con Claude, guiados desde la pantalla al frente del salón. Al cerrar, el salón se convierte en la noche.",
      ...
      "event.status": "EVENTO DE LA COMUNIDAD DE CLAUDE · MEXICO TECH WEEK 2026 · SEDE ANFITRIONA: CASA LUMA",
      "event.mainRoom": "SALÓN PRINCIPAL",
      "event.gallery": "LA GALERÍA",
      "event.mainRoomCount": "2 SETS",
      "event.galleryCount": "1 ESPACIO",
      ...
      "event.galleryName": "ARTE DIGITAL",
      "event.galleryNote": "Obras digitales curadas dentro del espacio",
      ...
      "close.kicker": "FUTURE RENAISSANCE EN CASA LUMA",
    ...
    zh: {
      ...
      "event.status": "CLAUDE 社区活动 · 墨西哥科技周 2026 · 主办场地：CASA LUMA",
      ...
      "event.galleryName": "数字艺术",
      "event.galleryNote": "数字作品经过策划融入该空间",
      ...
      "close.kicker": "FUTURE RENAISSANCE · CASA LUMA",
