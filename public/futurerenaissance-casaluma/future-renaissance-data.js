(function () {
  ...
  window.FUTURE_RENAISSANCE = Object.freeze({
    ...
    city: "Mexico City",
    slug: "/futurerenaissance-casaluma",
    attendees: 120,
    targetAttendance: 120,
  ...
  window.FUTURE_RENAISSANCE_ARTISTS = Object.freeze({
    "verse-works": Object.freeze({
      ...
      facts: [
        ...
        ["AT CASA LUMA", "Generative works on the venue screens"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN CASA LUMA", "Obra generativa en las pantallas"],
        ],
      },
      zh: {
        kind: "平台",
    ...
    pixelord: Object.freeze({
      name: "Pixelord",
      monogram: "PX",
      monogramMedia: Object.freeze({ type: "image", src: "/futurerenaissance-casaluma/pixelord.jpg", alt: "Pixelord" }),
      kind: "ARTIST",
      tag: "ARTIST",
      ...
      facts: [
        ...
        ["AT CASA LUMA", "Digital work in the line up"],
      ],
      handle: "",
      ...
      es: {
        ...
        facts: [
          ...
          ["EN CASA LUMA", "Obra digital en el line up"],
        ],
      },
      zh: {
        kind: "艺术家",
        ...
        facts: [
          ...
          ["在 CASA LUMA", "Future Renaissance 阵容中的数字作品"],
        ],
      },
    }),
