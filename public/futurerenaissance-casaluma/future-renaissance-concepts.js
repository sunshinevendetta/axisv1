(function () {
  ...
  var formatDefinitions = {
    ...
    "format-mapping": ["Video mapping", "Projected imagery extends the Future Renaissance visual world through Casa Luma.", ["Venue-specific treatment", "Brand integration where useful", "Live visual moments", "Capture-ready output"]],
  ...
  var systemDefinitions = {
    ...
    "system-arrive": ["Guests arrive", "Access and role states are established as the guest enters Casa Luma."],
  ...
  add("program-gallery", "03 / PROGRAM 04", "The Gallery", "A distinct space inside the event where the Future Renaissance digital art is presented.", [
    "Digital works are curated into the space rather than treated as decoration.",
    "The Gallery is part of the Future Renaissance experience alongside the main room.",
    "The space is open across the night.",
  ]);
  ...
  add("claude-ai", "10 / CLAUDE", "Hands-on session", "Four seated hours in which attendees work with Claude themselves, rather than watching a demo.", [
  ...
  add("req-power", "15 / VENUE PROVIDES", "Power + access", "Technical access, load-in time and a venue technical contact.", ["The venue opens at 16:00 so the room is ready before 17:00", "Access before doors for setup and soundcheck"]);
  ...
  (function () {
    ...
    addI18n("req-power", "es", "Energía + acceso", "Acceso técnico, tiempo de montaje y un contacto técnico del venue.", ["El venue abre a las 16:00 para que el salón esté listo antes de las 17:00","Acceso antes de la apertura de puertas para montaje y prueba de sonido"]);
    ...
    addI18n("req-power", "zh", "电力 + 场地准入", "技术准入、进场搭建时间以及一位场地技术联络人。", ["场地 16:00 开门，以便在 17:00 前完成布置","开门迎宾前需可进场进行搭建与音响调试"]);
  ...
  (function () {
    ...
    addI18n("format-mapping", "es", "Video mapping", "Las imágenes proyectadas extienden el universo visual de Future Renaissance a través de Casa Luma.", ["Tratamiento específico para el venue", "Integración de marca cuando resulte útil", "Momentos visuales en vivo", "Resultado listo para captura"]);
    ...
    addI18n("format-mapping", "zh", "光雕投影", "投影影像将 Future Renaissance 的视觉世界延伸至整个 Casa Luma。", ["针对场地定制的处理方式", "在适当时机融入品牌元素", "现场视觉时刻", "可直接用于拍摄记录的成片"]);
  ...
  (function () {
    ...
    addI18n("system-arrive", "es", "Los invitados llegan", "Los estados de acceso y rol se establecen cuando el invitado ingresa a Casa Luma.", systemDetailsEs);
    ...
    addI18n("system-arrive", "zh", "宾客抵达", "宾客进入 Casa Luma 时，系统建立访问权限和角色状态。", systemDetailsZh);
  ...
  window.FUTURE_RENAISSANCE_CONCEPT_ICONS = {
    ...
    "program-warmup": "disc", "program-liveCoding": "code", "program-closing": "disc", "program-gallery": "gallery",
