(function () {
  ...
  var root = "/futurerenaissance-casaluma/brand-assets/axis_future_renaissance_brand_assets";
  var orientation = document.documentElement.dataset.orientation || "horizontal";
  var poster = orientation === "vertical"
    ? "/futurerenaissance-casaluma/poster-vertical.png"
    : "/futurerenaissance-casaluma/poster-horizontal.png";
  ...
  function roomHuds() {
    ...
    hudPanel("gallery", "event.gallery", "THE GALLERY", "event.galleryCount", "1 SPACE", [
      lineupCell("slot", "program-gallery",
        "event.arcAllNight", "ALL NIGHT",
        "event.galleryName", "DIGITAL ART",
        "event.galleryNote", "Digital works curated into the space"),
    ]);
  }
  ...
  // 17:00 to 21:00 seated, then the room turns over and the night opens at
  // 21:00 with no gap. The clock is the spine of the ask: everything the venue
  // has to do hangs off a time.
  var workshopClock = [
  ...
  var slides = [
    ...
    '<section class="fr-slide fr-workshop" data-slide-id="workshop" data-scene="structured" data-label="The workshop">' +
      ...
      '<div class="workshop-heading" data-decode>' +
        ...
        '<p data-reveal data-i18n="workshop.copy">Four seated hours built for people who work in music. Producers, artists, labels, managers and studios work hands-on with Claude, led from the screen at the front of the room. When it closes at 21:00, the room becomes the night.</p>' +
      '</div>' +
